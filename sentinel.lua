...
spawn(function()
	...
	local function v_u_342(p_u_308, p309, p310, p311)
		local v312 = Create(
			"Frame",
			{
				["Name"] = "Arrow Graphic",
		...
		if p309 == nil or p309 == "Up" then
			v313 = function(p314, p315)
				return p314, p315
			end
		elseif p309 == "Down" then
			v313 = function(p316, p317)
				return UDim2.new(0, p316.X.Offset, 0, p_u_308 - p316.Y.Offset - 1), p317
			end
		elseif p309 == "Left" then
			v313 = function(p318, p319)
				return UDim2.new(0, p318.Y.Offset, 0, p318.X.Offset), UDim2.new(0, p319.Y.Offset, 0, p319.X.Offset)
			end
		elseif p309 == "Right" then
			v313 = function(p320, p321)
				return UDim2.new(0, p_u_308 - p320.Y.Offset - 1, 0, p320.X.Offset),
					UDim2.new(0, p321.Y.Offset, 0, p321.X.Offset)
			end
		end
		local v322
		if p310 then
			v322 = function(p323, p324)
			...
			v322 = function(p325, p326)
				return p325, p326
			end
		end
		local v327 = p_u_308 / 4
		local v328 = math.floor(v327)
		if p_u_308 % 2 == 0 then
			local v329 = p_u_308 / 2 - 1
			for v330 = 0, v329 do
				local v331 = p311:Clone()
				local v332, v333 =
					v322(v313(UDim2.new(0, v329 - v330, 0, v328 + v330), UDim2.new(0, (v330 + 1) * 2, 0, 1)))
				v331.Position = v332
				v331.Size = v333
				v331.Parent = v312
			end
		else
			local v334 = (p_u_308 - 1) / 2
			for v335 = 0, v334 do
				local v336 = p311:Clone()
				local v337, v338 =
					v322(v313(UDim2.new(0, v334 - v335, 0, v328 + v335), UDim2.new(0, v335 * 2 + 1, 0, 1)))
				v336.Position = v337
				v336.Size = v338
				v336.Parent = v312
			end
		...
		if 1 < p_u_308 % 4 then
			local v339 = p311:Clone()
			local v340, v341 = v322(v313(UDim2.new(0, 0, 0, p_u_308 - v328 - 1), UDim2.new(0, p_u_308, 0, 1)))
			v339.Position = v340
			v339.Size = v341
			v339.Parent = v312
		end
	...
	local function v_u_357(p_u_343, p344, p345, p346, p347)
		local v348 = Create(
			"Frame",
			{
				["Name"] = "Grip Graphic",
				["BorderSizePixel"] = 0,
				["Size"] = UDim2.new(0, p_u_343.x, 0, p_u_343.y),
				["Transparency"] = 1,
			}
		)
		if not p347 then
			p347 = Instance.new("Frame")
			p347.BorderSizePixel = 0
		end
		local v349 = p345 or 2
		local v350
		if p346 then
			v350 = function(p351)
				return UDim2.new(p351.X.Offset / p_u_343.x, 0, p351.Y.Offset / p_u_343.y, 0)
			end
		else
			v350 = function(p352)
				return p352
		...
		if p344 == "Vertical" then
			for v353 = 0, p_u_343.x - 1, v349 do
				local v354 = p347:Clone()
				v354.Size = v350(UDim2.new(0, 1, 0, p_u_343.y))
				v354.Position = v350(UDim2.new(0, v353, 0, 0))
				v354.Parent = v348
			end
			return v348
		else
			if p344 == nil or p344 == "Horizontal" then
				for v355 = 0, p_u_343.y - 1, v349 do
					local v356 = p347:Clone()
					v356.Size = v350(UDim2.new(0, p_u_343.x, 0, 1))
					v356.Position = v350(UDim2.new(0, 0, 0, v355))
					v356.Parent = v348
				end
			end
			return v348
	...
	local v_u_368 = {
		["__index"] = {
			["GetScrollPercent"] = function(p358)
				return p358.ScrollIndex / (p358.TotalSpace - p358.VisibleSpace)
			end,
			["CanScrollDown"] = function(p359)
				return p359.ScrollIndex + p359.VisibleSpace < p359.TotalSpace
			end,
			["CanScrollUp"] = function(p360)
				return 0 < p360.ScrollIndex
			end,
			["ScrollDown"] = function(p361)
				p361.ScrollIndex = p361.ScrollIndex + p361.PageIncrement
				p361:Update()
			end,
			["ScrollUp"] = function(p362)
				p362.ScrollIndex = p362.ScrollIndex - p362.PageIncrement
				p362:Update()
			end,
			["ScrollTo"] = function(p363, p364)
				p363.ScrollIndex = p364
				p363:Update()
			end,
			["SetScrollPercent"] = function(p365, p366)
				local v367 = (p365.TotalSpace - p365.VisibleSpace) * p366 + 0.5
				p365.ScrollIndex = math.floor(v367)
				p365:Update()
			end,
		},
	}
	v_u_368.__index.CanScrollRight = v_u_368.__index.CanScrollDown
	v_u_368.__index.CanScrollLeft = v_u_368.__index.CanScrollUp
	v_u_368.__index.ScrollLeft = v_u_368.__index.ScrollUp
	v_u_368.__index.ScrollRight = v_u_368.__index.ScrollDown
	function ScrollBar(p369)
		local v_u_370 = Create(
			"Frame",
			{
				["Name"] = "ScrollFrame",
				["Position"] = p369 and UDim2.new(0, 0, 1, -16) or UDim2.new(1, -16, 0, 0),
				["Size"] = p369 and UDim2.new(1, 0, 0, 16) or UDim2.new(0, 16, 1, 0),
				["BackgroundTransparency"] = 1,
				Create(
					"ImageButton",
					{
						["Name"] = "ScrollDown",
						["Position"] = p369 and UDim2.new(1, -16, 0, 0) or UDim2.new(0, 0, 1, -16),
				...
				Create(
					...
					{
						["Name"] = "ScrollBar",
						["Size"] = p369 and UDim2.new(1, -32, 1, 0) or UDim2.new(1, 0, 1, -32),
						["Position"] = p369 and UDim2.new(0, 16, 0, 0) or UDim2.new(0, 0, 0, 16),
		...
		local v_u_372 = v_u_370.ScrollDown
		local v373 = v_u_342
		local v374 = 8
		local v375
		if p369 then
		...
		local v_u_376 = v373(v374, v375, true, v371)
		v_u_376.Position = UDim2.new(0.5, -4, 0.5, -4)
		v_u_376.Parent = v_u_372
		local v_u_377 = v_u_370.ScrollUp
		local v378 = v_u_342
		local v379 = 8
		local v380
		if p369 then
		...
		local v_u_381 = v378(v379, v380, true, v371)
		v_u_381.Position = UDim2.new(0.5, -4, 0.5, -4)
		v_u_381.Parent = v_u_377
		local v_u_382 = v_u_370.ScrollBar
		local v_u_383 = v_u_382.ScrollThumb
		local v384 = v_u_357
		local v385 = Vector2.new(6, 6)
		local v386
		if p369 then
			v386 = "Vertical"
		else
		...
		local v387 = v384(v385, v386, 2, v371)
		v387.Position = UDim2.new(0.5, -3, 0.5, -3)
		v387.Parent = v_u_383
		local v_u_388 = setmetatable(
			{ ["GUI"] = v_u_370, ["ScrollIndex"] = 0, ["VisibleSpace"] = 0, ["TotalSpace"] = 0, ["PageIncrement"] = 1 },
			v_u_368
		)
		local v_u_389
		if p369 then
			v_u_389 = function()
				v_u_383.Size = UDim2.new(v_u_388.VisibleSpace / v_u_388.TotalSpace, 0, 0, 16)
				if v_u_383.AbsoluteSize.x < 16 then
					v_u_383.Size = UDim2.new(0, 16, 0, 16)
				end
				local v390 = v_u_382.AbsoluteSize.x
				v_u_383.Position =
					UDim2.new(v_u_388:GetScrollPercent() * (v390 - v_u_383.AbsoluteSize.x) / v390, 0, 0, 0)
			end
		else
			v_u_389 = function()
				v_u_383.Size = UDim2.new(0, 16, v_u_388.VisibleSpace / v_u_388.TotalSpace, 0)
				if v_u_383.AbsoluteSize.y < 16 then
					v_u_383.Size = UDim2.new(0, 16, 0, 16)
				end
				local v391 = v_u_382.AbsoluteSize.y
				v_u_383.Position =
					UDim2.new(0, 0, v_u_388:GetScrollPercent() * (v391 - v_u_383.AbsoluteSize.y) / v391, 0)
			end
		end
		local v_u_392 = nil
		local v_u_393 = nil
		local v_u_394 = { ["BackgroundColor3"] = v_u_267.Border, ["BackgroundTransparency"] = 0 }
		local v_u_395 = { ["BackgroundColor3"] = v_u_267.Border, ["BackgroundTransparency"] = 0.7 }
		local function v407()
			local v396 = v_u_388.TotalSpace
			local v397 = v_u_388.VisibleSpace
			local v398 = v_u_388.ScrollIndex
			if v397 <= v396 then
				if 0 < v398 then
					if v396 < v398 + v397 then
						v_u_388.ScrollIndex = v396 - v397
					end
				else
			...
			if v_u_388.UpdateCallback and v_u_388.UpdateCallback(v_u_388) == false then
				...
				if v399 ~= v_u_392 then
					v_u_392 = v399
					v_u_372.Active = v399
					v_u_372.AutoButtonColor = v399
					local v401 = v_u_376:GetChildren()
					local v402 = v399 and v_u_394
					if not v402 then
						v402 = v_u_395
					end
					for v403 = 1, #v401 do
						Create(v401[v403], v402)
					end
				end
				if v400 ~= v_u_393 then
					v_u_393 = v400
					v_u_377.Active = v400
					v_u_377.AutoButtonColor = v400
					local v404 = v_u_381:GetChildren()
					local v405 = v400 and v_u_394
					if not v405 then
						v405 = v_u_395
					end
					for v406 = 1, #v404 do
						Create(v404[v406], v405)
					end
				end
				v_u_383.Visible = v399 or v400
				v_u_389()
			end
		end
		v_u_388.Update = v407
		SetZIndexOnChanged(v_u_370)
		local v_u_408 = Create(
			"ImageButton",
			{
				["Name"] = "MouseDrag",
		...
		local v_u_409 = 0
		v_u_372.MouseButton1Down:connect(function()
			v_u_409 = tick()
			local v410 = v_u_409
			local v_u_411 = nil
			v_u_411 = v_u_408.MouseButton1Up:connect(function()
				v_u_409 = tick()
				v_u_408.Parent = nil
				v_u_307(v_u_372)
				v_u_411:disconnect()
			...
			v_u_408.Parent = GetScreen(v_u_370)
			v_u_388:ScrollDown()
			wait(0.2)
			while v_u_409 == v410 do
				v_u_388:ScrollDown()
				if not v_u_388:CanScrollDown() then
					break
				end
				wait()
			end
		end)
		v_u_372.MouseButton1Up:connect(function()
			v_u_409 = tick()
		end)
		v_u_377.MouseButton1Down:connect(function()
			v_u_409 = tick()
			local v412 = v_u_409
			local v_u_413 = nil
			v_u_413 = v_u_408.MouseButton1Up:connect(function()
				v_u_409 = tick()
				v_u_408.Parent = nil
				v_u_307(v_u_377)
				v_u_413:disconnect()
			...
			v_u_388:ScrollUp()
			wait(0.2)
			while v_u_409 == v412 do
				v_u_388:ScrollUp()
				if not v_u_388:CanScrollUp() then
					break
				end
				wait()
			end
		end)
		v_u_377.MouseButton1Up:connect(function()
			v_u_409 = tick()
		end)
		if p369 then
			v_u_382.MouseButton1Down:connect(function(p414, _)
				v_u_409 = tick()
				local v415 = v_u_409
				local v_u_416 = nil
				v_u_416 = v_u_408.MouseButton1Up:connect(function()
					v_u_409 = tick()
					v_u_408.Parent = nil
					v_u_307(v_u_377)
					v_u_416:disconnect()
				...
				v_u_408.Parent = GetScreen(v_u_370)
				if v_u_383.AbsolutePosition.x < p414 then
					v_u_388:ScrollTo(v_u_388.ScrollIndex + v_u_388.VisibleSpace)
					wait(0.2)
					while v_u_409 == v415 and p414 >= v_u_383.AbsolutePosition.x + v_u_383.AbsoluteSize.x do
						v_u_388:ScrollTo(v_u_388.ScrollIndex + v_u_388.VisibleSpace)
						wait()
					end
				else
					v_u_388:ScrollTo(v_u_388.ScrollIndex - v_u_388.VisibleSpace)
					wait(0.2)
					while v_u_409 == v415 and v_u_383.AbsolutePosition.x >= p414 do
						v_u_388:ScrollTo(v_u_388.ScrollIndex - v_u_388.VisibleSpace)
						wait()
					end
				end
			...
			v_u_382.MouseButton1Down:connect(function(_, p417)
				v_u_409 = tick()
				local v418 = v_u_409
				local v_u_419 = nil
				v_u_419 = v_u_408.MouseButton1Up:connect(function()
					v_u_409 = tick()
					v_u_408.Parent = nil
					v_u_307(v_u_377)
					v_u_419:disconnect()
				...
				v_u_408.Parent = GetScreen(v_u_370)
				if v_u_383.AbsolutePosition.y < p417 then
					v_u_388:ScrollTo(v_u_388.ScrollIndex + v_u_388.VisibleSpace)
					wait(0.2)
					while v_u_409 == v418 and p417 >= v_u_383.AbsolutePosition.y + v_u_383.AbsoluteSize.y do
						v_u_388:ScrollTo(v_u_388.ScrollIndex + v_u_388.VisibleSpace)
						wait()
					end
				else
					v_u_388:ScrollTo(v_u_388.ScrollIndex - v_u_388.VisibleSpace)
					wait(0.2)
					while v_u_409 == v418 and v_u_383.AbsolutePosition.y >= p417 do
						v_u_388:ScrollTo(v_u_388.ScrollIndex - v_u_388.VisibleSpace)
						wait()
					end
				end
		...
		if p369 then
			v_u_383.MouseButton1Down:connect(function(p420, _)
				v_u_409 = tick()
				local v_u_421 = p420 - v_u_383.AbsolutePosition.x
				local v_u_422 = nil
				local v_u_428 = v_u_408.MouseMoved:connect(function(p423, _)
					local v424 = v_u_382.AbsolutePosition.x
					local v425 = v_u_382.AbsoluteSize.x - v_u_383.AbsoluteSize.x
					local v426 = v424 + v425
					local v427 = p423 - v_u_421
					if v427 < v424 and v424 then
						v427 = v424
					elseif v426 < v427 then
						if v426 then
							v427 = v426
						end
					end
					v_u_388:SetScrollPercent((v427 - v424) / v425)
				end)
				v_u_422 = v_u_408.MouseButton1Up:connect(function()
					v_u_409 = tick()
					v_u_408.Parent = nil
					v_u_307(v_u_383)
					v_u_428:disconnect()
			...
			v_u_383.MouseButton1Down:connect(function(_, p429)
				v_u_409 = tick()
				local v_u_430 = p429 - v_u_383.AbsolutePosition.y
				local v_u_431 = nil
				local v_u_437 = v_u_408.MouseMoved:connect(function(_, p432)
					local v433 = v_u_382.AbsolutePosition.y
					local v434 = v_u_382.AbsoluteSize.y - v_u_383.AbsoluteSize.y
					local v435 = v433 + v434
					local v436 = p432 - v_u_430
					if v436 < v433 and v433 then
						v436 = v433
					elseif v435 < v436 then
						if v435 then
							v436 = v435
						end
					end
					v_u_388:SetScrollPercent((v436 - v433) / v434)
				end)
				v_u_431 = v_u_408.MouseButton1Up:connect(function()
					v_u_409 = tick()
					v_u_408.Parent = nil
					v_u_307(v_u_383)
					v_u_437:disconnect()
		...
		function v_u_388.Destroy(_)
			v_u_370:Destroy()
			v_u_408:Destroy()
			for v438 in pairs(v_u_388) do
				v_u_388[v438] = nil
			end
			setmetatable(v_u_388, nil)
		end
		v407()
		return v_u_388
	end
	local v_u_439 = v_u_164.ExplorerPanel
	Create(v_u_439, { ["BackgroundColor3"] = v_u_267.Field, ["BorderColor3"] = v_u_267.Border, ["Active"] = true })
	local v_u_440 = v_u_439.Parent:WaitForChild("SettingsPanel"):WaitForChild("GetSetting")
	local v441 = v_u_439.Parent:WaitForChild("PropertiesFrame"):WaitForChild("GetApi")
	local v_u_442 = v_u_439.Parent:WaitForChild("PropertiesFrame"):WaitForChild("GetAwaiting")
	local v_u_443 = v_u_439.Parent:WaitForChild("PropertiesFrame"):WaitForChild("SetAwaiting")
	local v_u_444 = v_u_439.Parent:WaitForChild("SaveInstance")
	local v_u_445 = v_u_439.Parent:WaitForChild("Confirmation")
	local v_u_446 = v_u_439.Parent:WaitForChild("Caution")
	local v_u_447 = v_u_439.Parent:WaitForChild("TableCaution")
	local v_u_448 = v_u_439.Parent:WaitForChild("CallRemote")
	local v_u_449 = v_u_439.Parent:WaitForChild("ScriptEditor"):WaitForChild("OpenScript")
	local v_u_450 = nil
	local v_u_451 = nil
	local v_u_452 = nil
	local v_u_453 = nil
	...
	if v_u_455 then
		v_u_453 = Instance.new("Folder")
		v_u_453.Name = "Dex"
		v_u_454 = Instance.new("Folder", v_u_453)
		v_u_454.Name = "DexStorage"
	end
	local v_u_456 = nil
	local v_u_457 = nil
	local v_u_458 = nil
	if get_nil_instances then
		if IfThisFunctionWasStableEnough then
			v_u_458 = true
		end
	end
	if v_u_458 then
		v_u_456 = Instance.new("Folder")
		v_u_456.Name = "Dex Internal Storage"
		v_u_457 = Instance.new("Folder", v_u_456)
		v_u_457.Name = "Nil Instances"
	end
	local v_u_459 = Create(
		"Frame",
		{
			["Name"] = "List",
			["BackgroundTransparency"] = 1,
	...
	local v_u_460 = ScrollBar(false)
	v_u_460.PageIncrement = 1
	Create(
		v_u_460.GUI,
		{ ["Position"] = UDim2.new(1, -16, 0, 36), ["Size"] = UDim2.new(0, 16, 1, -36), ["Parent"] = v_u_439 }
	)
	local v_u_461 = ScrollBar(true)
	v_u_461.PageIncrement = 16
	Create(
		v_u_461.GUI,
		{
	...
	v_u_463.Parent = v_u_462
	SetZIndexOnChanged(v_u_439)
	local function v467(p464, p465, p466)
		return Color3.new(p464 / 255, p465 / 255, p466 / 255)
	end
	local v468 =
		{ ["Font"] = Enum.Font.Arial, ["Margin"] = 5, ["Black"] = v467(0, 0, 0), ["White"] = v467(255, 255, 255) }
	local v_u_469 = {
		["Font"] = v468.Font,
		["FontSize"] = Enum.FontSize.Size14,
		["TextColor"] = v467(0, 0, 0),
		["TextColorOver"] = v468.White,
		["TextXAlignment"] = Enum.TextXAlignment.Left,
		["Height"] = 20,
		["BackColor"] = v468.White,
		["BackColorOver"] = v467(86, 125, 188),
		["BorderColor"] = v467(216, 216, 216),
		["BorderSizePixel"] = 2,
		["ArrowColor"] = v467(160, 160, 160),
		["ArrowColorOver"] = v468.Black,
	}
	local _ = {
		["Font"] = v468.Font,
		["FontSize"] = Enum.FontSize.Size14,
		["TextXAlignment"] = Enum.TextXAlignment.Left,
		["TextColor"] = v468.Black,
		["TextColorOver"] = v468.White,
		["TextLockedColor"] = v467(120, 120, 120),
		["Height"] = 24,
		["BorderColor"] = v467(216, 216, 216),
		["BackgroundColor"] = v468.White,
		["BackgroundColorAlternate"] = v467(246, 246, 246),
		["BackgroundColorMouseover"] = v467(211, 224, 244),
		["TitleMarginLeft"] = 15,
	}
	local v_u_470 = nil
	local v_u_471 = nil
	local v_u_472 = nil
	local v_u_473 = nil
	function ClassCanCreate(p_u_474)
		local _, v475 = pcall(function()
			Instance.new(p_u_474)
		end)
		return not v475
	end
	function GetClasses()
		...
		local v476 = {}
		for _, v477 in pairs(v_u_473.Classes) do
			if ClassCanCreate(v477.Name) then
				local v478 = v477.Name
				table.insert(v476, v478)
			end
		end
		return v476
	end
	local function v_u_483(p479, p_u_480)
		table.sort(p479, function(p481, p482)
			return p481[p_u_480] < p482[p_u_480]
		end)
	end
	local function v_u_487(p484)
		local v485 = p484.tags
		for _, v486 in pairs(v485) do
			if v486 == "deprecated" or v486 == "hidden" or v486 == "writeonly" then
				return true
			end
		end
		return false
	end
	local function v_u_492(p488)
		local v489 = v_u_473.Classes[p488]
		local v490 = {}
		if not v489 then
			return v490
		end
		while v489 and v489.Name ~= "Instance" do
			for _, v491 in pairs(v489.Functions) do
				if not v_u_487(v491) then
					table.insert(v490, v491)
				end
			end
			v489 = v_u_473.Classes[v489.Superclass]
		end
		v_u_483(v490, "Name")
		return v490
	end
	function GetFunctions()
		...
		local v493 = SelectionVar():Get()
		if #v493 ~= 0 then
			local v494 = v493[1]
			local v495 = {}
			for _, v496 in pairs(v_u_492(v494.ClassName)) do
				table.insert(v495, v496)
			end
			return v495
		end
	end
	function CreateInsertObjectMenu(p_u_497, _, _, p_u_498)
		game.Players.LocalPlayer:GetMouse()
		local _ = v_u_439.Parent.AbsoluteSize.y
		if #p_u_497 ~= 0 then
			table.sort(p_u_497, function(p499, p500)
				return p499 < p500
			end)
			local v_u_501 = Instance.new("Frame")
			v_u_501.Name = "InsertObject"
			v_u_501.Size = UDim2.new(0, 200, 1, 0)
			v_u_501.BackgroundTransparency = 1
			v_u_501.Active = true
			local v_u_502 = nil
			local v_u_503 = false
			local v_u_504 = v_u_469.BorderSizePixel
			local function v_u_505()
				v_u_503 = false
				if v_u_501 then
					v_u_471.Visible = false
				end
			end
			(function()
				v_u_503 = true
				v_u_502 = Instance.new("ScrollingFrame")
				v_u_502.Size = UDim2.new(0, 200, 1, 0)
				v_u_502.CanvasSize = UDim2.new(0, 200, 0, #p_u_497 * v_u_469.Height)
				v_u_502.Position = UDim2.new(0, v_u_504, 0, 0)
				v_u_502.BackgroundTransparency = 0
				v_u_502.BackgroundColor3 = v_u_469.BackColor
				v_u_502.BorderColor3 = v_u_469.BorderColor
				v_u_502.BorderSizePixel = v_u_469.BorderSizePixel
				v_u_502.TopImage = "rbxasset://textures/blackBkg_square.png"
				v_u_502.MidImage = "rbxasset://textures/blackBkg_square.png"
				v_u_502.BottomImage = "rbxasset://textures/blackBkg_square.png"
				v_u_502.Active = true
				v_u_502.ZIndex = 5
				v_u_502.Parent = v_u_501
				local function v_u_507(p506)
					p_u_498(p506)
					v_u_505()
				end
				for v508, v_u_509 in pairs(p_u_497) do
					local v510 = CreateRightClickMenuItem(v_u_509, function()
						v_u_507(v_u_509)
					end, 1)
					v510.Size = UDim2.new(1, 0, 0, 20)
					v510.Position = UDim2.new(0, 0, 0, (v508 - 1) * v_u_469.Height)
					v510.ZIndex = v_u_502.ZIndex
					v510.Parent = v_u_502
				end
			end)()
			return v_u_501
	...
	function CreateFunctionCallerMenu(p_u_511, _, _, p_u_512)
		game.Players.LocalPlayer:GetMouse()
		local _ = v_u_439.Parent.AbsoluteSize.y
		if #p_u_511 ~= 0 then
			table.sort(p_u_511, function(p513, p514)
				return p513.Name < p514.Name
			end)
			local v_u_515 = Instance.new("Frame")
			v_u_515.Name = "InsertObject"
			v_u_515.Size = UDim2.new(0, 200, 1, 0)
			v_u_515.BackgroundTransparency = 1
			v_u_515.Active = true
			local v_u_516 = nil
			local v_u_517 = false
			local v_u_518 = v_u_469.BorderSizePixel
			local function v_u_519()
				v_u_517 = false
				if v_u_515 then
					v_u_471.Visible = false
				end
			...
			(function()
				v_u_517 = true
				v_u_516 = Instance.new("ScrollingFrame")
				v_u_516.Size = UDim2.new(0, 300, 1, 0)
				v_u_516.CanvasSize = UDim2.new(0, 300, 0, #p_u_511 * v_u_469.Height)
				v_u_516.Position = UDim2.new(0, v_u_518, 0, 0)
				v_u_516.BackgroundTransparency = 0
				v_u_516.BackgroundColor3 = v_u_469.BackColor
				v_u_516.BorderColor3 = v_u_469.BorderColor
				v_u_516.BorderSizePixel = v_u_469.BorderSizePixel
				v_u_516.TopImage = "rbxasset://textures/blackBkg_square.png"
				v_u_516.MidImage = "rbxasset://textures/blackBkg_square.png"
				v_u_516.BottomImage = "rbxasset://textures/blackBkg_square.png"
				v_u_516.Active = true
				v_u_516.ZIndex = 5
				v_u_516.Parent = v_u_515
				local function v526(p520)
					local v521 = "" .. "("
					for v522, v523 in pairs(p520.Arguments) do
						local v524 = v523.Type
						local v525 = v523.Name
						v521 = v521 .. v524 .. " " .. v525
						if v522 < #p520.Arguments then
							v521 = v521 .. ", "
						end
					end
					return v521 .. ")"
				end
				local function v_u_528(p527)
					p_u_512(p527)
					v_u_519()
				end
				for v529, v_u_530 in pairs(p_u_511) do
					local v531 = CreateRightClickMenuItem
					local v532 = v_u_530.ReturnType
					local v533 = v_u_530.Name
					local v534 = v526(v_u_530)
					local v535 = v531(v532 .. " " .. v533 .. v534, function()
						v_u_528(v_u_530)
					end, 2)
					v535.Size = UDim2.new(1, 0, 0, 20)
					v535.Position = UDim2.new(0, 0, 0, (v529 - 1) * v_u_469.Height)
					v535.ZIndex = v_u_516.ZIndex
					v535.Parent = v_u_516
				end
			end)()
			return v_u_515
	...
	function CreateInsertObject()
		if v_u_471 then
			v_u_471.Visible = true
			if v_u_470 and v_u_471.Visible then
				v_u_471.Position = UDim2.new(0, v_u_470.Position.X.Offset - v_u_470.Size.X.Offset - 2, 0, 0)
			end
			if v_u_471.Visible then
				v_u_471.Parent = v_u_439.Parent
			end
		end
	end
	function CreateFunctionCaller()
		...
		v_u_472 = CreateFunctionCallerMenu(GetFunctions(), "", false, function(p_u_536)
			v_u_472:Destroy()
			v_u_472 = nil
			local v_u_537 = SelectionVar():Get()
			for v_u_538 = 1, #v_u_537 do
				pcall(function()
					Instance.new(p_u_536, v_u_537[v_u_538])
				end)
			end
			print(p_u_536.Name .. " selected to be called. Function caller being added soon, please wait!")
			DestroyRightClick()
		end)
		if v_u_470 and v_u_472 then
			v_u_472.Position = UDim2.new(0, v_u_470.Position.X.Offset - v_u_470.Size.X.Offset * 1.5 - 2, 0, 0)
		end
		if v_u_472 then
			v_u_472.Parent = v_u_439.Parent
		end
	end
	function CreateRightClickMenuItem(p_u_539, p_u_540, p_u_541)
		local v_u_542 = Instance.new("TextButton")
		v_u_542.Font = v_u_469.Font
		v_u_542.FontSize = v_u_469.FontSize
		v_u_542.TextColor3 = v_u_469.TextColor
		v_u_542.TextXAlignment = v_u_469.TextXAlignment
		v_u_542.BackgroundColor3 = v_u_469.BackColor
		v_u_542.AutoButtonColor = false
		v_u_542.BorderSizePixel = 0
		v_u_542.Active = true
		v_u_542.Text = p_u_539
		if p_u_541 == 1 then
			local v543 = v_u_304(nil, v_u_268[p_u_539] or 0)
			v543.Position = UDim2.new(0, 0, 0, 2)
			v543.Size = UDim2.new(0, 16, 0, 16)
			v543.IconMap.ZIndex = 5
			v543.Parent = v_u_542
			v_u_542.Text = "\t\t" .. v_u_542.Text
		elseif p_u_541 == 2 then
			v_u_542.FontSize = Enum.FontSize.Size11
		end
		v_u_542.MouseEnter:connect(function()
			v_u_542.TextColor3 = v_u_469.TextColorOver
			v_u_542.BackgroundColor3 = v_u_469.BackColorOver
			if not p_u_541 and v_u_471 then
				if v_u_471.Visible == false and v_u_542.Text == "Insert Object" then
					CreateInsertObject()
				elseif v_u_471.Visible and v_u_542.Text ~= "Insert Object" then
					v_u_471.Visible = false
				end
			end
			if not p_u_541 then
				if v_u_472 and v_u_542.Text ~= "Call Function" then
					v_u_472:Destroy()
					v_u_472 = nil
					return
				end
				if v_u_542.Text == "Call Function" then
					CreateFunctionCaller()
				end
			end
		end)
		v_u_542.MouseLeave:connect(function()
			v_u_542.TextColor3 = v_u_469.TextColor
			v_u_542.BackgroundColor3 = v_u_469.BackColor
		end)
		v_u_542.MouseButton1Click:connect(function()
			v_u_542.TextColor3 = v_u_469.TextColor
			v_u_542.BackgroundColor3 = v_u_469.BackColor
			p_u_540(p_u_539)
		end)
	...
	function CreateRightClickMenu(p_u_544, _, _, p_u_545)
		game.Players.LocalPlayer:GetMouse()
		local v_u_546 = Instance.new("Frame")
		v_u_546.Name = "DropDown"
		v_u_546.Size = UDim2.new(0, 200, 1, 0)
		v_u_546.BackgroundTransparency = 1
		v_u_546.Active = true
		local v_u_547 = nil
		local v_u_548 = false
		local v_u_549 = v_u_469.BorderSizePixel
		...
		(function()
			v_u_548 = true
			v_u_547 = Instance.new("Frame")
			v_u_547.Size = UDim2.new(0, 200, 0, #p_u_544 * v_u_469.Height)
			v_u_547.Position = UDim2.new(0, v_u_549, 0, 5)
			v_u_547.BackgroundTransparency = 0
			v_u_547.BackgroundColor3 = v_u_469.BackColor
			v_u_547.BorderColor3 = v_u_469.BorderColor
			v_u_547.BorderSizePixel = v_u_469.BorderSizePixel
			v_u_547.Active = true
			v_u_547.ZIndex = 5
			v_u_547.Parent = v_u_546
			local function v_u_552(p551)
				p_u_545(p551)
				v_u_550()
			end
			for v553, v_u_554 in pairs(p_u_544) do
				local v555 = CreateRightClickMenuItem(v_u_554, function()
					v_u_552(v_u_554)
				end)
				v555.Size = UDim2.new(1, 0, 0, 20)
				v555.Position = UDim2.new(0, 0, 0, (v553 - 1) * v_u_469.Height)
				v555.ZIndex = v_u_547.ZIndex
				v555.Parent = v_u_547
			end
		end)()
		return v_u_546
	end
	function checkMouseInGui(p556)
		if p556 == nil then
			return false
		end
		local v557 = game.Players.LocalPlayer:GetMouse()
		local v558 = p556.AbsolutePosition
		local v559 = p556.AbsoluteSize
		return v557.X >= v558.x and v557.X <= v558.x + v559.x and v557.Y >= v558.y and v557.Y <= v558.y + v559.y
	end
	local v_u_560 = {}
	local function v_u_562(p561)
		p561.Parent = nil
	end
	local v_u_563 = Create(
		"TextLabel",
		{
			["Name"] = "TextWidth",
			["TextXAlignment"] = "Left",
	...
	local function v_u_565(p564)
		v_u_563.Text = p564
		return v_u_563.TextBounds.x
	end
	local v_u_566 = false
	local v_u_567 = {}
	local v_u_568 = {}
	...
	function filteringWorkspace()
		return v_u_463.Text ~= "" and v_u_463.Text ~= "Filter Workspace"
	end
	function lookForAName(p571, p572)
		for _, v573 in pairs(p571:GetChildren()) do
			if string.find(string.lower(v573.Name), string.lower(p572)) then
				v_u_566 = true
			end
			lookForAName(v573, p572)
		end
	end
	function scanName(p574)
		v_u_566 = false
		if string.find(string.lower(p574.Name), string.lower(v_u_463.Text)) then
			v_u_566 = true
		else
			lookForAName(p574, v_u_463.Text)
		end
		return v_u_566
	end
	function updateActions()
		for _, v575 in pairs(v_u_570) do
			if v575.Cond() then
				v575.Toggle(true)
			else
				v575.Toggle(false)
	...
	local function v_u_579(p576)
		for v577 = 1, #p576 do
			if not filteringWorkspace() or scanName(p576[v577].Object) then
				v_u_567[#v_u_567 + 1] = p576[v577]
				local v578 = p576[v577].Depth * 19 + 2 + 18 + 4 + v_u_565(p576[v577].Object.Name) + 4
				if v_u_569 < v578 then
					v_u_569 = v578
				end
				if p576[v577].Expanded or filteringWorkspace() then
					v_u_579(p576[v577])
				end
			end
		end
	end
	local function v_u_596()
		v_u_461.TotalSpace = v_u_569
		v_u_461.VisibleSpace = v_u_459.AbsoluteSize.x
		v_u_461:Update()
		local v580 = v_u_461:CanScrollDown() or v_u_461:CanScrollUp()
		v_u_461.GUI.Visible = v580
		local v581 = v_u_459
		local v582 = UDim2.new
		local v583 = 1
		local v584 = -16
		local v585 = 1
		local v586 = -16
		...
		v581.Size = v582(v583, v584, v585, v586 * v587 - 36)
		local v588 = v_u_459.AbsoluteSize.y / 19
		v_u_460.VisibleSpace = math.ceil(v588)
		local v589 = v_u_460.GUI
		local v590 = UDim2.new
		local v591 = 0
		local v592 = 16
		local v593 = 1
		local v594 = -16
		...
		v589.Size = v590(v591, v592, v593, v594 * v595 - 36)
		v_u_460.TotalSpace = #v_u_567 + 1
		v_u_460:Update()
	end
	local function v_u_597()
		v_u_567 = {}
		v_u_569 = 0
		v_u_579(v_u_568[workspace.Parent])
		if v_u_455 then
			v_u_579(v_u_568[v_u_453])
		end
		if v_u_458 then
			v_u_579(v_u_568[v_u_456])
		end
		v_u_596()
		updateActions()
	end
	...
	local v602 = v_u_439:FindFirstChild("TotallyNotGetSelection")
	if not v602 then
		v602 = Create("BindableFunction", { ["Name"] = "TotallyNotGetSelection" })
		v602.Parent = v_u_439
	end
	local v603 = v_u_439:FindFirstChild("TotallyNotSetSelection")
	if not v603 then
		v603 = Create("BindableFunction", { ["Name"] = "TotallyNotSetSelection" })
		v603.Parent = v_u_439
	end
	local v_u_604 = v_u_439:FindFirstChild("TotallyNotSelectionChanged")
	if not v_u_604 then
		v_u_604 = Create("BindableEvent", { ["Name"] = "TotallyNotSelectionChanged" })
		v_u_604.Parent = v_u_439
	end
	local v_u_605 = {}
	local v_u_606 = {}
	local v_u_607 = true
	local v_u_608 = { ["Selected"] = v_u_606, ["List"] = v_u_605 }
	local function v_u_614(p609)
		local v610 = false
		local v611 = false
		if not v_u_606[p609] then
			local v612 = v_u_568[p609]
			if v612 then
				table.insert(v_u_605, p609)
				v_u_606[p609] = true
				v612.Selected = true
				local v613 = v612.Parent
				while v613 do
					if not v613.Expanded then
						v613.Expanded = true
						v610 = true
					end
					v613 = v613.Parent
	...
	function v_u_608.Set(_, p615)
		local v616 = false
		local v617
		if 0 < #v_u_605 then
			for v618 = 1, #v_u_605 do
				local v619 = v_u_605[v618]
				local v620 = v_u_568[v619]
				if v620 then
					v620.Selected = false
					v_u_606[v619] = nil
				end
			...
			v_u_605 = {}
			v_u_608.List = v_u_605
			v617 = true
		else
			v617 = false
		end
		for v621 = 1, #p615 do
			local v622, v623 = v_u_614(p615[v621])
			v617 = v623 or v617
			v616 = v622 or v616
			v617 = v623 or v617
			v616 = v622 or v616
	...
	function v_u_608.Add(_, p624)
		local v625, v626 = v_u_614(p624)
		if v625 then
			v_u_597()
			if v_u_607 then
				v_u_604:Fire()
	...
	function v_u_608.StopUpdates(_)
		v_u_607 = false
	end
	function v_u_608.ResumeUpdates(_)
		v_u_607 = true
		v_u_604:Fire()
		updateActions()
	end
	function v_u_608.Remove(_, p627, p628)
		local v629 = v_u_606[p627] and v_u_568[p627]
		if v629 then
			v629.Selected = false
			v_u_606[p627] = nil
			for v630 = 1, #v_u_605 do
				if v_u_605[v630] == p627 then
					table.remove(v_u_605, v630)
					break
				end
			end
			if not p628 then
	...
	function v_u_608.Get(_)
		local v631 = {}
		for v632 = 1, #v_u_605 do
			v631[v632] = v_u_605[v632]
		end
		return v631
	end
	function v603.OnInvoke(...)
		v_u_608:Set(...)
	end
	function v602.OnInvoke()
		return v_u_608:Get()
	end
	function CreateCaution(p633, p634)
		local v_u_635 = v_u_446:Clone()
		v_u_635.Title.Text = p633
		v_u_635.MainWindow.Desc.Text = p634
		v_u_635.Parent = v_u_439.Parent
		v_u_635.Visible = true
		v_u_635.MainWindow.Ok.MouseButton1Up:connect(function()
			v_u_635:Destroy()
		end)
	end
	function CreateTableCaution(p636, p637)
		if type(p637) ~= "table" then
			return CreateCaution(p636, tostring(p637))
		end
		local v_u_638 = v_u_447:Clone()
		v_u_638.Title.Text = p636
		local v639 = v_u_638.MainWindow.TableResults
		local v640 = v_u_638.MainWindow.TableTemplate
		for _, v641 in pairs(p637) do
			local v642 = v640:Clone()
			v642.Type.Text = type(v641)
			v642.Value.Text = tostring(v641)
			v642.Position = UDim2.new(0, 0, 0, #v639:GetChildren() * 20)
			v642.Parent = v639
			v639.CanvasSize = UDim2.new(0, 0, 0, #v639:GetChildren() * 20)
			v642.Visible = true
		end
		v_u_638.Parent = v_u_439.Parent
		v_u_638.Visible = true
		v_u_638.MainWindow.Ok.MouseButton1Up:connect(function()
			v_u_638:Destroy()
		end)
	end
	local function v_u_651(p643, p644)
		local v645 = {}
		local v646 = 1
		while true do
			local v647 = string.find(p643, p644, v646, true)
			if not v647 then
				break
			end
			local v648 = v647 - 1
			local v649 = string.sub
			table.insert(v645, v649(p643, v646, v648))
			v646 = v647 + string.len(p644)
		end
		local v650 = string.sub
		table.insert(v645, v650(p643, v646))
		return v645
	end
	local function v_u_675(p_u_652, p653)
		if p653 == "Vector2" then
			local v654 = v_u_651(p_u_652, ",")
			if #v654 < 2 then
				return nil
			end
			local v655 = tonumber(v654[1]) or 0
			local v656 = tonumber(v654[2]) or 0
			return Vector2.new(v655, v656)
		end
		if p653 == "Vector3" then
			local v657 = v_u_651(p_u_652, ",")
			if #v657 < 3 then
				return nil
			end
			local v658 = tonumber(v657[1]) or 0
			local v659 = tonumber(v657[2]) or 0
			local v660 = tonumber(v657[3]) or 0
			return Vector3.new(v658, v659, v660)
		end
		if p653 == "Color3" then
			local v661 = v_u_651(p_u_652, ",")
			if #v661 < 3 then
				return nil
			end
			local v662 = tonumber(v661[1]) or 0
			local v663 = tonumber(v661[2]) or 0
			local v664 = tonumber(v661[3]) or 0
			return Color3.new(v662 / 255, v663 / 255, v664 / 255)
		end
		if p653 == "UDim2" then
			local v665 = v_u_651(string.gsub(string.gsub(p_u_652, "{", ""), "}", ""), ",")
			if #v665 < 4 then
				return nil
			end
			local v666 = tonumber(v665[1]) or 0
			local v667 = tonumber(v665[2]) or 0
			local v668 = tonumber(v665[3]) or 0
			local v669 = tonumber(v665[4]) or 0
			return UDim2.new(v666, v667, v668, v669)
		end
		if p653 == "Number" then
			return tonumber(p_u_652)
		end
		if p653 == "String" then
			return p_u_652
		end
		if p653 == "NumberRange" then
			local v670 = v_u_651(p_u_652, ",")
			if #v670 == 1 then
				if tonumber(v670[1]) == nil then
					return nil
				end
				local v671 = tonumber(v670[1]) or 0
				return NumberRange.new(v671)
			end
			if #v670 < 2 then
				return nil
			end
			local v672 = tonumber(v670[1]) or 0
			local v673 = tonumber(v670[2]) or 0
			return NumberRange.new(v672, v673)
		end
		if p653 ~= "Script" then
			return nil
		end
		local _, v674 = ypcall(function()
			_G.D_E_X_DONOTUSETHISPLEASE = nil
			loadstring("_G.D_E_X_DONOTUSETHISPLEASE = " .. p_u_652)()
	...
	function PromptRemoteCaller(p_u_676)
		if v_u_451 then
			v_u_451:Destroy()
			v_u_451 = nil
		end
		v_u_451 = v_u_448:Clone()
		v_u_451.Parent = v_u_439.Parent
		v_u_451.Visible = true
		local v_u_677 = false
		local v_u_678 = v_u_451.MainWindow.Arguments
		local v_u_679 = v_u_451.MainWindow.ArgumentTemplate
		if p_u_676:IsA("RemoteEvent") then
			v_u_451.Title.Text = "Fire Event"
			v_u_451.MainWindow.Ok.Text = "Fire"
			v_u_451.MainWindow.DisplayReturned.Visible = false
			v_u_451.MainWindow.Desc2.Visible = false
		end
		local v_u_680 = v_u_679:Clone()
		v_u_680.Parent = v_u_678
		v_u_680.Visible = true
		v_u_680.Type.MouseButton1Down:connect(function()
			createDDown(v_u_680.Type, function(p681)
				v_u_680.Type.Text = p681
			end, "Script", "Number", "String", "Color3", "Vector3", "Vector2", "UDim2", "NumberRange")
		end)
		v_u_451.MainWindow.Ok.MouseButton1Up:connect(function()
			if v_u_451 and p_u_676.Parent ~= nil then
				local v_u_682 = {}
				for _, v683 in pairs(v_u_678:GetChildren()) do
					local v684 = v683.Value.Text
					local v685 = v683.Type.Text
					table.insert(v_u_682, v_u_675(v684, v685))
				end
				if p_u_676:IsA("RemoteFunction") then
					if v_u_677 then
						spawn(function()
							local v686 = p_u_676:InvokeServer(unpack(v_u_682))
							if v686 then
								CreateTableCaution("Remote Caller", v686)
							else
						...
						spawn(function()
							p_u_676:InvokeServer(unpack(v_u_682))
						end)
					end
				else
					p_u_676:FireServer(unpack(v_u_682))
				end
				v_u_451:Destroy()
				v_u_451 = nil
			end
		end)
		v_u_451.MainWindow.Add.MouseButton1Up:connect(function()
			if v_u_451 then
				local v_u_687 = v_u_679:Clone()
				v_u_687.Position = UDim2.new(0, 0, 0, #v_u_678:GetChildren() * 20)
				v_u_687.Parent = v_u_678
				v_u_678.CanvasSize = UDim2.new(0, 0, 0, #v_u_678:GetChildren() * 20)
				v_u_687.Visible = true
				v_u_687.Type.MouseButton1Down:connect(function()
					createDDown(v_u_687.Type, function(p688)
						v_u_687.Type.Text = p688
					end, "Script", "Number", "String", "Color3", "Vector3", "Vector2", "UDim2", "NumberRange")
				end)
			end
		end)
		v_u_451.MainWindow.Subtract.MouseButton1Up:connect(function()
			if v_u_451 and 1 < #v_u_678:GetChildren() then
				v_u_678:GetChildren()[#v_u_678:GetChildren()]:Destroy()
				v_u_678.CanvasSize = UDim2.new(0, 0, 0, #v_u_678:GetChildren() * 20)
			end
		end)
		v_u_451.MainWindow.Cancel.MouseButton1Up:connect(function()
			if v_u_451 then
				v_u_451:Destroy()
				v_u_451 = nil
			end
		end)
		v_u_451.MainWindow.DisplayReturned.MouseButton1Up:connect(function()
			if v_u_677 then
				v_u_677 = false
				v_u_451.MainWindow.DisplayReturned.enabled.Visible = false
			else
				v_u_677 = true
				v_u_451.MainWindow.DisplayReturned.enabled.Visible = true
			end
		end)
	end
	function PromptSaveInstance(p_u_689)
		if SaveInstance or _G.SaveInstance then
			if v_u_450 then
				v_u_450:Destroy()
				v_u_450 = nil
				if v_u_439.Parent:FindFirstChild("SaveInstanceOverwriteCaution") then
					v_u_439.Parent.SaveInstanceOverwriteCaution:Destroy()
				end
			end
			v_u_450 = v_u_444:Clone()
			v_u_450.Parent = v_u_439.Parent
			v_u_450.Visible = true
			local v_u_690 = v_u_450.MainWindow.FileName
			local v_u_691 = true
			local v_u_692 = false
			v_u_450.MainWindow.Save.MouseButton1Up:connect(function()
				if readfile and getelysianpath then
					if readfile(getelysianpath() .. v_u_690.Text .. ".rbxmx") then
						if not v_u_692 then
							v_u_692 = true
							local v_u_693 = v_u_445:Clone()
							v_u_693.Name = "SaveInstanceOverwriteCaution"
							v_u_693.MainWindow.Desc.Text = "The file, "
								.. v_u_690.Text
								.. ".rbxmx, already exists. Overwrite?"
							v_u_693.Parent = v_u_439.Parent
							v_u_693.Visible = true
							v_u_693.MainWindow.Yes.MouseButton1Up:connect(function()
								ypcall(function()
									SaveInstance(p_u_689, v_u_690.Text .. ".rbxmx", not v_u_691)
								end)
								v_u_692 = false
								v_u_693:Destroy()
								if v_u_450 then
							...
							v_u_693.MainWindow.No.MouseButton1Up:connect(function()
								v_u_692 = false
								v_u_693:Destroy()
							end)
							return
					...
					ypcall(function()
						if SaveInstance then
							...
							_G.SaveInstance(p_u_689, v_u_690.Text, not v_u_691)
						end
					end)
					if v_u_450 then
						v_u_450:Destroy()
			...
			v_u_450.MainWindow.Cancel.MouseButton1Up:connect(function()
				if v_u_450 then
					v_u_450:Destroy()
					v_u_450 = nil
					if v_u_439.Parent:FindFirstChild("SaveInstanceOverwriteCaution") then
			...
			v_u_450.MainWindow.SaveObjects.MouseButton1Up:connect(function()
				if v_u_691 then
					v_u_691 = false
					v_u_450.MainWindow.SaveObjects.enabled.Visible = false
				else
					v_u_691 = true
					v_u_450.MainWindow.SaveObjects.enabled.Visible = true
				end
			end)
		else
			CreateCaution(
	...
	function DestroyRightClick()
		...
		if v_u_471 and v_u_471.Visible then
			v_u_471.Visible = false
		end
	end
	function rightClickMenu(_)
		local v694 = game.Players.LocalPlayer:GetMouse()
		v_u_470 = CreateRightClickMenu(
			{
				"Cut",
				"Copy",
				"Paste Into",
			...
			function(p695)
				if p695 == "Cut" then
					if v_u_260.Modifiable then
						v_u_560 = {}
						local v696 = v_u_608.List
						local v697 = {}
						for v698 = 1, #v696 do
							local v699 = v696[v698]:Clone()
							if v699 then
								table.insert(v_u_560, v699)
								local v700 = v696[v698]
								table.insert(v697, v700)
							end
						end
						for v701 = 1, #v697 do
							pcall(v_u_562, v697[v701])
						end
						updateActions()
					end
				elseif p695 == "Copy" then
					if v_u_260.Modifiable then
						v_u_560 = {}
						local v702 = v_u_608.List
						for v703 = 1, #v702 do
							local v704 = v702[v703]
							table.insert(v_u_560, v704:Clone())
						end
						updateActions()
					end
				elseif p695 == "Paste Into" then
					if v_u_260.Modifiable then
						local v705 = v_u_608.List[1] or workspace
						for v706 = 1, #v_u_560 do
							v_u_560[v706]:Clone().Parent = v705
						end
					end
				elseif p695 == "Duplicate" then
					if v_u_260.Modifiable then
						local v707 = v_u_608:Get()
						for v708 = 1, #v707 do
							v707[v708]:Clone().Parent = v_u_608.List[1].Parent or workspace
						end
					end
				elseif p695 == "Delete" then
					if v_u_260.Modifiable then
						local v709 = v_u_608:Get()
						for v710 = 1, #v709 do
							pcall(v_u_562, v709[v710])
						end
						v_u_608:Set({})
					end
				elseif p695 == "Group" then
					if v_u_260.Modifiable then
						local v711 = Instance.new("Model")
						local v712 = v_u_608:Get()
						v711.Parent = v_u_608.List[1].Parent or workspace
						for v713 = 1, #v712 do
							v712[v713].Parent = v711
						end
						v_u_608:Set({})
					end
				else
					if p695 == "Ungroup" then
						if not v_u_260.Modifiable then
							return
						end
						local v714 = {}
						local v715 = v_u_608:Get()
						for v716 = 1, #v715 do
							if v715[v716]:IsA("Model") then
								for _, v717 in pairs(v715[v716]:GetChildren()) do
									v717.Parent = v715[v716].Parent or workspace
									table.insert(v714, v717)
								end
								pcall(v_u_562, v715[v716])
							end
						end
						v_u_608:Set({})
						if v_u_440:Invoke("SelectUngrouped") then
							for _, v718 in pairs(v714) do
								v_u_608:Add(v718)
							end
							return
						end
					else
						if p695 == "Select Children" then
							if v_u_260.Modifiable then
								local v719 = v_u_608:Get()
								v_u_608:Set({})
								v_u_608:StopUpdates()
								for v720 = 1, #v719 do
									for _, v721 in pairs(v719[v720]:GetChildren()) do
										v_u_608:Add(v721)
									end
								end
								v_u_608:ResumeUpdates()
							end
						end
						if p695 == "Teleport To" then
							if v_u_260.Modifiable then
								local v_u_722 = v_u_608:Get()
								for v_u_723 = 1, #v_u_722 do
									if v_u_722[v_u_723]:IsA("BasePart") then
										pcall(function()
											game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
												v_u_722[v_u_723].CFrame
										end)
										return
									end
								end
						...
						if p695 == "Insert Part" then
							if v_u_260.Modifiable then
								local v_u_724 = {}
								local v_u_725 = v_u_608:Get()
								for v_u_726 = 1, #v_u_725 do
									pcall(function()
										local v727 = Instance.new("Part")
										v727.Parent = v_u_725[v_u_726]
										v727.CFrame = CFrame.new(game.Players.LocalPlayer.Character.Head.Position)
											+ Vector3.new(0, 3, 0)
										table.insert(v_u_724, v727)
									end)
								end
							end
						end
						if p695 == "Save Instance" then
							if not v_u_260.Modifiable then
								return
							end
							local v_u_728 = v_u_608:Get()
							if #v_u_728 == 1 then
								v_u_728[1].Archivable = true
								ypcall(function()
									PromptSaveInstance(v_u_728[1]:Clone())
								end)
								return
							end
							if 1 < #v_u_728 then
								local v_u_729 = Instance.new("Model")
								v_u_729.Name = "SavedInstances"
								for v_u_730 = 1, #v_u_728 do
									ypcall(function()
										v_u_728[v_u_730].Archivable = true
										v_u_728[v_u_730]:Clone().Parent = v_u_729
									end)
								end
								PromptSaveInstance(v_u_729)
								return
							end
						else
							if p695 == "Call Remote" then
								if v_u_260.Modifiable then
									local v731 = v_u_608:Get()
									for v732 = 1, #v731 do
										if v731[v732]:IsA("RemoteFunction") or v731[v732]:IsA("RemoteEvent") then
											PromptRemoteCaller(v731[v732])
											return
										end
									end
								end
							end
							if p695 == "View Script" then
								if not v_u_260.Modifiable then
									return
								end
								local v733 = v_u_608:Get()
								for v734 = 1, #v733 do
									if v733[v734]:IsA("LocalScript") or v733[v734]:IsA("ModuleScript") then
										v_u_449:Fire(v733[v734])
									end
								end
							end
						end
		...
		v_u_470.Parent = v_u_439.Parent
		v_u_470.Position = UDim2.new(0, v694.X, 0, v694.Y)
		if
			v_u_470.AbsolutePosition.X + v_u_470.AbsoluteSize.X
			> v_u_439.AbsolutePosition.X + v_u_439.AbsoluteSize.X
		then
			v_u_470.Position =
				UDim2.new(0, v_u_439.AbsolutePosition.X + v_u_439.AbsoluteSize.X - v_u_470.AbsoluteSize.X, 0, v694.Y)
		end
	end
	local function v_u_735() end
	local function v_u_736() end
	local v_u_737 = {}
	local v_u_738 = {}
	local v_u_739 = Create(
		"ImageButton",
		{
			["Name"] = "MouseDrag",
			["Position"] = UDim2.new(-0.25, 0, -0.25, 0),
	...
	local function v_u_754(p_u_740, p_u_741, p742)
		local v_u_743 = nil
		conDrag = v_u_739.MouseMoved:connect(function(p744, p745)
			...
			if v746.x < 0 or v746.x > v747.x or v746.y < 0 or v746.y > v747.y then
				...
				local v750
				if v749 < p_u_740 and v749 then
					v750 = v749
				else
					v750 = p_u_740
				end
				local v751
				if p_u_740 < v749 and v749 then
					v751 = v749
				else
					v751 = p_u_740
				end
				for v752 = v750, v751 do
					local v753 = v_u_567[v752]
					if v753 then
						if p_u_741 then
							v_u_608:Add(v753.Object)
						else
							v_u_608:Remove(v753.Object)
						end
					end
				end
				p_u_740 = v749
		...
		v_u_736 = function()
			...
			conDrag:disconnect()
			v_u_743:disconnect()
			v_u_736 = function() end
		end
		v_u_743 = v_u_739[p742]:connect(v_u_736)
		v_u_739.Parent = GetScreen(v_u_459)
	end
	local function v_u_781(p_u_755, p_u_756, p_u_757, p_u_758)
		local v_u_759 = nil
		local v_u_760 = nil
		local v_u_761 = nil
		local v_u_762 = false
		local v_u_763 = Create(
			"Frame",
			{
				["Transparency"] = 1,
				["Visible"] = false,
		...
		SetZIndex(v_u_763, 9)
		conDrag = v_u_739.MouseMoved:connect(function(p764, p765)
			local v766 = Vector2.new(p764, p765)
			if v_u_762 then
				local v767 = v766 - v_u_459.AbsolutePosition
				local v768 = v_u_459.AbsoluteSize
				v_u_761 = nil
				v_u_763.Visible = false
				if 0 <= v767.x and v767.x <= v768.x and 0 <= v767.y and v767.y <= v768.y + 36 then
					local v769 = v767.y / 19 - 2
					local v770 = math.ceil(v769)
					local v771 = v_u_567[v770 + v_u_460.ScrollIndex]
					if v771 and v771.Object ~= p_u_755 and not p_u_755:IsAncestorOf(v771.Object) then
						v_u_761 = v770
						local v772 = v_u_737[v770]
						if v772 then
							v_u_763.Visible = true
							v_u_763.Position = UDim2.new(0, 1, 0, v772.AbsolutePosition.y - v_u_459.AbsolutePosition.y)
							v_u_763.Size = UDim2.new(0, v768.x - 4, 0, v772.AbsoluteSize.y)
						end
					end
				end
				p_u_756.Position = UDim2.new(0, v766.x + p_u_758.x, 0, v766.y + p_u_758.y)
			elseif 8 < (p_u_757 - v766).magnitude then
				v_u_762 = true
				SetZIndex(p_u_756, 9)
				p_u_756.IndentFrame.Transparency = 0.25
				p_u_756.IndentFrame.EntryText.TextColor3 = v_u_267.TextSelected
				p_u_756.Position = UDim2.new(0, v766.x + p_u_758.x, 0, v766.y + p_u_758.y)
				p_u_756.Parent = GetScreen(v_u_459)
				v_u_763.Parent = v_u_459
			end
		end)
		v_u_735 = function()
			v_u_739.Parent = nil
			...
			p_u_756:Destroy()
			v_u_763:Destroy()
			v_u_735 = function() end
		end
		local v_u_773 = v_u_608.Selected[p_u_755]
		if not v_u_773 and v_u_260.Selectable then
			v_u_608:Set({ p_u_755 })
		end
		v_u_759 = v_u_739.MouseButton1Up:connect(function()
			v_u_735()
			if v_u_762 then
				local v774 = v_u_761 and v_u_567[v_u_761 + v_u_460.ScrollIndex]
				if v774 then
					v774.Expanded = true
					local v775 = v774.Object
					local function v778(p776, p777)
						p776.Parent = p777
					end
					if v_u_260.Selectable then
						local v779 = v_u_608.List
						for v780 = 1, #v779 do
							pcall(v778, v779[v780], v775)
						end
					else
						pcall(v778, p_u_755, v775)
					end
				end
			elseif v_u_773 and v_u_260.Selectable then
				v_u_608:Set({})
			end
		end)
		v_u_760 = v_u_739.MouseButton2Down:connect(function()
			v_u_735()
		end)
		v_u_739.Parent = GetScreen(v_u_459)
	end
	local v_u_782 = Create(
		"ImageButton",
		{
			["Name"] = "Entry",
			["Transparency"] = 1,
	...
	function v_u_460.UpdateCallback(p_u_783)
		for v_u_784 = 1, p_u_783.VisibleSpace do
			local v785 = v_u_567[v_u_784 + p_u_783.ScrollIndex]
			if v785 then
				local v786 = v_u_737[v_u_784]
				if not v786 then
					local v_u_787 = Create(
						v_u_782:Clone(),
						{
							["Position"] = UDim2.new(0, 2, 0, 19 * (v_u_784 - 1) + 2),
							["Size"] = UDim2.new(0, v_u_569, 0, 18),
							["ZIndex"] = v_u_459.ZIndex,
						}
					)
					v_u_737[v_u_784] = v_u_787
					local v_u_788 = v_u_787.IndentFrame.Expand
					v_u_788.MouseEnter:connect(function()
						local v789 = v_u_567[v_u_784 + p_u_783.ScrollIndex]
						if 0 < #v789 then
							if v789.Expanded then
								v_u_304(v_u_788, 180)
								return
							end
							v_u_304(v_u_788, 179)
					...
					v_u_788.MouseLeave:connect(function()
						local v790 = v_u_567[v_u_784 + p_u_783.ScrollIndex]
						if 0 < #v790 then
							if v790.Expanded then
								v_u_304(v_u_788, 166)
								return
							end
							v_u_304(v_u_788, 165)
					...
					v_u_788.MouseButton1Down:connect(function()
						local v791 = v_u_567[v_u_784 + p_u_783.ScrollIndex]
						if 0 < #v791 then
							v791.Expanded = not v791.Expanded
							if v791.Object == v_u_439.Parent and v791.Expanded then
								CreateCaution(
									"Warning",
					...
					v_u_787.MouseButton1Down:connect(function(p792, p793)
						local v794 = v_u_567[v_u_784 + p_u_783.ScrollIndex]
						DestroyRightClick()
						if v_u_442:Invoke() then
							v_u_443:Fire(v794.Object)
							return
						else
							if not v_u_263 then
								v_u_452 = v_u_784 + p_u_783.ScrollIndex
							end
							if v_u_263 and not filteringWorkspace() then
								if v_u_452 then
									if 0 < v_u_784 + p_u_783.ScrollIndex - v_u_452 then
										v_u_608:StopUpdates()
										for v795 = 1, v_u_784 + p_u_783.ScrollIndex - v_u_452 do
											local v796 = v_u_567[v_u_452 + v795]
											if v796 then
												v_u_608:Add(v796.Object)
											end
										end
										v_u_608:ResumeUpdates()
										return
									...
									v_u_608:StopUpdates()
									for v797 = v_u_784 + p_u_783.ScrollIndex - v_u_452, 1 do
										local v798 = v_u_567[v_u_452 + v797]
										if v798 then
											v_u_608:Add(v798.Object)
										end
									end
									v_u_608:ResumeUpdates()
								end
								return
							elseif v_u_262 then
								if v_u_608.Selected[v794.Object] then
									v_u_608:Remove(v794.Object)
								else
									v_u_608:Add(v794.Object)
								end
							elseif v_u_260.Modifiable then
								local v799 = Vector2.new(p792, p793)
								v_u_781(v794.Object, v_u_787:Clone(), v799, v_u_787.AbsolutePosition - v799)
							elseif v_u_260.Selectable then
								if v_u_608.Selected[v794.Object] then
									v_u_608:Set({})
								else
									v_u_608:Set({ v794.Object })
								end
								v_u_754(v_u_784 + p_u_783.ScrollIndex, true, "MouseButton1Up")
							end
						end
					end)
					v_u_787.MouseButton2Down:connect(function()
						if v_u_260.Selectable then
							DestroyRightClick()
							curSelect = v_u_787
							local v800 = v_u_567[v_u_784 + p_u_783.ScrollIndex]
							if v_u_442:Invoke() then
								v_u_443:Fire(v800.Object)
							elseif not v_u_608.Selected[v800.Object] then
								v_u_608:Set({ v800.Object })
							end
						else
							return
						end
					end)
					v_u_787.MouseButton2Up:connect(function()
						if v_u_260.Selectable then
							local v801 = v_u_567[v_u_784 + p_u_783.ScrollIndex]
							if checkMouseInGui(curSelect) then
								rightClickMenu(v801.Object)
							end
						end
					end)
					v_u_787.Parent = v_u_459
					v786 = v_u_787
				end
				v786.Visible = true
				local v_u_802 = v785.Object
				if #v785 == 0 then
					v786.IndentFrame.Expand.Visible = false
				elseif v785.Expanded then
					v_u_304(v786.IndentFrame.Expand, 166)
					v786.IndentFrame.Expand.Visible = true
				else
					v_u_304(v786.IndentFrame.Expand, 165)
					v786.IndentFrame.Expand.Visible = true
				end
				v_u_304(v786.IndentFrame.ExplorerIcon, v_u_268[v_u_802.ClassName] or 0)
				local v803 = v785.Depth * 19
				v786.IndentFrame.Position = UDim2.new(0, v803, 0, 0)
				v786.IndentFrame.Size = UDim2.new(1, -v803, 1, 0)
				if v_u_738[v786] then
					v_u_738[v786]:disconnect()
				end
				local v_u_804 = v786.IndentFrame.EntryText
				v_u_804.Text = v_u_802.Name
				v_u_738[v786] = v785.Object.Changed:connect(function(p805)
					if p805 == "Name" then
						v_u_804.Text = v_u_802.Name
					end
				end)
				local v806 = v786.IndentFrame
				local v807
				if v785.Selected then
					v807 = 0
				else
					v807 = 1
				end
				v806.Transparency = v807
				local v808 = v_u_267
				local v809
				if v785.Selected then
					v809 = "TextSelected"
				...
				v_u_804.TextColor3 = v808[v809]
				v786.Size = UDim2.new(0, v_u_569, 0, 18)
			elseif v_u_737[v_u_784] then
				v_u_737[v_u_784].Visible = false
			end
		end
		for v810 = p_u_783.VisibleSpace + 1, p_u_783.TotalSpace do
			local v811 = v_u_737[v810]
			if v811 then
				v_u_737[v810] = nil
				v811:Destroy()
			end
	...
	function v_u_461.UpdateCallback(_)
		for v812 = 1, v_u_460.VisibleSpace do
			if v_u_567[v812 + v_u_460.ScrollIndex] then
				local v813 = v_u_737[v812]
				if v813 then
					v813.Position = UDim2.new(0, 2 - v_u_461.ScrollIndex, 0, 19 * (v812 - 1) + 2)
				end
			end
		end
	end
	Connect(v_u_459.Changed, function(p814)
		if p814 == "AbsoluteSize" then
			v_u_596()
		end
	end)
	v_u_439.MouseWheelForward:connect(function()
		if 6 < v_u_460.VisibleSpace - 1 then
			v_u_460:ScrollTo(v_u_460.ScrollIndex - 6)
		else
			v_u_460:ScrollTo(v_u_460.ScrollIndex - v_u_460.VisibleSpace)
		end
	end)
	v_u_439.MouseWheelBackward:connect(function()
		if 6 < v_u_460.VisibleSpace - 1 then
			v_u_460:ScrollTo(v_u_460.ScrollIndex + 6)
		else
			v_u_460:ScrollTo(v_u_460.ScrollIndex + v_u_460.VisibleSpace)
	...
	local function v_u_820(p815, p816, p817)
		for v818 = #p815, p816, -1 do
			local v819 = p815[v818]
			v819.Index = v818 + 1
			p815[v818 + 1] = v819
		end
		p817.Index = p816
	...
	local function v_u_826(p821, p822)
		local v823 = p821[p822]
		for v824 = p822 + 1, #p821 do
			local v825 = p821[v824]
			v825.Index = v824 - 1
			p821[v824 - 1] = v825
		end
		p821[#p821] = nil
	...
	local v_u_830 = {}
	local function v_u_834(p831)
		local v832 = p831.Parent
		local v833 = true
		while v832 and v833 do
			v833 = v833 and v832.Expanded
			v832 = v832.Parent
		end
		return v833
	end
	local function v_u_839(p835)
		local v836 = v_u_568[p835]
		if v836 then
			local v837 = v_u_834(v836)
			v_u_608:Remove(p835, true)
			local v838 = v836.Parent
			v_u_826(v838, v836.Index)
			v_u_568[p835] = nil
			v_u_830[p835]:disconnect()
			v_u_830[p835] = nil
			if v837 then
				v_u_599()
			elseif v_u_834(v838) then
				v_u_601()
			end
		else
			return
	...
	local function v_u_849(p840, p841)
		local v842 = v_u_568[p840]
		if v842 then
			local v843 = v_u_568[p841]
			if v843 then
				local v844 = v_u_834(v842)
				v_u_826(v842.Parent, v842.Index)
				v842.Parent = v843
				v842.Depth = v_u_829(p840)
				local function v_u_848(p845, p846)
					for v847 = 1, #p845 do
						p845[v847].Depth = p846
						v_u_848(p845[v847], p846 + 1)
					end
				end
				v_u_848(v842, v842.Depth + 1)
				v_u_820(v843, #v843 + 1, v842)
				if v844 or v_u_834(v842) then
					v_u_599()
				elseif v_u_834(v842.Parent) then
					v_u_601()
				end
			else
				return
	...
	local function v_u_851(p850)
		return p850.AncestryChanged
	end
	local function v_u_858(p_u_852, p853)
		if script and not pcall(v_u_851, p_u_852) then
			return
		else
			local v854 = v_u_568[p_u_852.Parent]
			if v854 then
				local v855 = {
					["Object"] = p_u_852,
					["Parent"] = v854,
					...
					["Expanded"] = false,
					["Selected"] = false,
					["Depth"] = v_u_829(p_u_852),
				}
				v_u_830[p_u_852] = Connect(p_u_852.AncestryChanged, function(p856, p857)
					if p856 == p_u_852 then
						if p857 == nil then
							v_u_839(p856)
							return
						end
				...
				v_u_568[p_u_852] = v855
				v_u_820(v854, #v854 + 1, v855)
				if not p853 then
					if v_u_834(v855) then
						v_u_599()
						return
					end
					if v_u_834(v855.Parent) then
						v_u_601()
					end
				end
			end
	...
	local function v862()
		local v_u_859 = nil
		local v860, _ = ypcall(function()
			v_u_859 = game:GetObjects("rbxasset://DexStorage.rbxm")[1]
		end)
		if v860 and v_u_859 then
			for _, v_u_861 in pairs(v_u_859:GetChildren()) do
				ypcall(function()
					v_u_861.Parent = v_u_454
				end)
			end
		end
	...
	local function v_u_865()
		if v_u_863 then
			...
			wait()
			pcall(function()
				saveinstance("content//DexStorage.rbxm", v_u_454)
			end)
			updateDexStorageListeners()
			v_u_863 = false
		end
	...
	function updateDexStorageListeners()
		for _, v866 in pairs(v_u_864) do
			v866:Disconnect()
		end
		v_u_864 = {}
		for _, v_u_867 in pairs(v_u_454:GetChildren()) do
			pcall(function()
				local v868 = v_u_867.Changed:connect(v_u_865)
				table.insert(v_u_864, v868)
			end)
		end
	end
	v_u_568[workspace.Parent] = { ["Object"] = workspace.Parent, ["Parent"] = nil, ["Index"] = 0, ["Expanded"] = true }
	if v_u_455 then
		v_u_568[v_u_453] = { ["Object"] = v_u_453, ["Parent"] = nil, ["Index"] = 0, ["Expanded"] = true }
	end
	if v_u_458 then
		v_u_568[v_u_456] = { ["Object"] = v_u_456, ["Parent"] = nil, ["Index"] = 0, ["Expanded"] = true }
	end
	Connect(game.DescendantAdded, v_u_858)
	Connect(game.DescendantRemoving, v_u_839)
	if v_u_455 then
		v862()
		Connect(v_u_453.DescendantAdded, v_u_858)
		Connect(v_u_453.DescendantRemoving, v_u_839)
		Connect(v_u_453.DescendantAdded, v_u_865)
		Connect(v_u_453.DescendantRemoving, v_u_865)
	end
	if v_u_458 then
		Connect(v_u_456.DescendantAdded, v_u_858)
		Connect(v_u_456.DescendantRemoving, v_u_839)
		local v_u_869 = get_nil_instances()
		spawn(function()
			while wait() do
				if #v_u_869 ~= #get_nil_instances() then
					v_u_869 = get_nil_instances()
					for _, v_u_870 in pairs(get_nil_instances()) do
						if v_u_870 ~= v_u_456 and v_u_870 ~= v_u_453 then
							pcall(function()
								v_u_870.Parent = v_u_457
							end)
						end
					end
				end
	...
	local function v_u_872(p871)
		return p871:GetChildren()
	end
	local function v_u_877(p873)
		local v874, v875 = pcall(v_u_872, p873)
		if v874 then
			for v876 = 1, #v875 do
				v_u_858(v875[v876], true)
				v_u_877(v875[v876])
			end
		end
	end
	v_u_877(workspace.Parent)
	if v_u_455 then
		v_u_877(v_u_453)
	end
	if v_u_458 then
	...
	local v878 = v_u_459.AbsoluteSize.y / 19
	v_u_460.VisibleSpace = math.ceil(v878)
	v_u_599()
	local v_u_879 = {}
	local v_u_880 = 1
	local function v888(p_u_881, p_u_882, p883, _, p884)
		local v_u_885 = false
		local v_u_886 = Create(
			v_u_304("ImageButton", p_u_881),
			{
				["Name"] = p883 .. "Button",
				["Visible"] = v_u_260.Modifiable and v_u_260.Selectable,
				["Position"] = UDim2.new(1, -18 * v_u_880 + 2, 0.25, -8),
				["Size"] = UDim2.new(0, 16, 0, 16),
				["Parent"] = v_u_462,
			}
		)
		...
		v_u_886.MouseEnter:connect(function()
			if v_u_885 then
				v_u_886.BackgroundTransparency = 0.9
			end
		end)
		v_u_886.MouseLeave:connect(function()
			v_u_886.BackgroundTransparency = 1
		end)
		v_u_880 = v_u_880 + 1
		v_u_879[#v_u_879 + 1] = { ["Obj"] = v_u_886, ["Cond"] = p884 }
		v_u_570[#v_u_879 + 1] = {
			["Obj"] = v_u_886,
			["Cond"] = p884,
			["Toggle"] = function(p887)
				if p887 then
					v_u_885 = true
					v_u_304(v_u_886, p_u_882)
				else
					v_u_885 = false
					v_u_304(v_u_886, p_u_881)
				end
			end,
		}
		return v_u_886
	end
	local function v_u_890(p889)
		p889.Parent = nil
	end
	v888(190, 190, "Options", true, function()
		return true
	end).MouseButton1Click:connect(function() end)
	v888(163, 177, "Delete", true, function()
		return 0 < #v_u_608:Get()
	end).MouseButton1Click:connect(function()
		if v_u_260.Modifiable then
			local v891 = v_u_608:Get()
			for v892 = 1, #v891 do
				pcall(v_u_890, v891[v892])
			end
			v_u_608:Set({})
		end
	end)
	v888(162, 176, "Paste", true, function()
		local v893
		if 0 < #v_u_608:Get() then
			v893 = 0 < #v_u_560
		else
			v893 = false
		end
		...
		if v_u_260.Modifiable then
			local v894 = v_u_608.List[1] or workspace
			for v895 = 1, #v_u_560 do
				v_u_560[v895]:Clone().Parent = v894
			end
		end
	end)
	v888(161, 175, "Copy", true, function()
		return 0 < #v_u_608:Get()
	end).MouseButton1Click:connect(function()
		if v_u_260.Modifiable then
			v_u_560 = {}
			local v896 = v_u_608.List
			for v897 = 1, #v896 do
				local v898 = v896[v897]
				table.insert(v_u_560, v898:Clone())
			end
			updateActions()
		end
	end)
	v888(160, 174, "Cut", true, function()
		return 0 < #v_u_608:Get()
	end).MouseButton1Click:connect(function()
		if v_u_260.Modifiable then
			v_u_560 = {}
			local v899 = v_u_608.List
			local v900 = {}
			for v901 = 1, #v899 do
				local v902 = v899[v901]:Clone()
				if v902 then
					table.insert(v_u_560, v902)
					local v903 = v899[v901]
					table.insert(v900, v903)
				end
			end
			for v904 = 1, #v900 do
				pcall(v_u_890, v900[v904])
			end
			updateActions()
		end
	end)
	v888(188, 188, "Freeze", true, function()
		return true
	end)
	v888(184, 187, "Star", true, function()
		return 0 < #v_u_608:Get()
	end)
	v888(189, 189, "Starred", true, function()
		return true
	end)
	local v_u_909 = {
		["Modifiable"] = function(p905)
			for v906 = 1, #v_u_879 do
				v_u_879[v906].Obj.Visible = p905 and v_u_260.Selectable
			end
			v_u_735()
		end,
		["Selectable"] = function(p907)
			for v908 = 1, #v_u_879 do
				v_u_879[v908].Obj.Visible = p907 and v_u_260.Modifiable
			end
			v_u_736()
			v_u_608:Set({})
		end,
	}
	local v910 = v_u_439:FindFirstChild("SetOption")
	if not v910 then
		v910 = Create("BindableFunction", { ["Name"] = "SetOption" })
		v910.Parent = v_u_439
	end
	function v910.OnInvoke(p911, p912)
		if v_u_909[p911] then
			v_u_260[p911] = p912
			v_u_909[p911](p912)
		end
	end
	local v913 = v_u_439:FindFirstChild("GetOption")
	if not v913 then
		v913 = Create("BindableFunction", { ["Name"] = "GetOption" })
		v913.Parent = v_u_439
	end
	function v913.OnInvoke(p914)
		if p914 then
			return v_u_260[p914]
		end
		local v915 = {}
		for v916, v917 in pairs(v_u_260) do
			v915[v916] = v917
		end
		return v915
	end
	...
	v261.InputBegan:connect(function(p918)
		if p918.KeyCode == Enum.KeyCode.LeftControl then
			v_u_262 = true
		end
		if p918.KeyCode == Enum.KeyCode.LeftShift then
			v_u_263 = true
		end
	end)
	v261.InputEnded:connect(function(p919)
		if p919.KeyCode == Enum.KeyCode.LeftControl then
			v_u_262 = false
		end
		if p919.KeyCode == Enum.KeyCode.LeftShift then
			v_u_263 = false
		end
	end)
	while v_u_473 == nil do
		v_u_473 = v441:Invoke()
		wait()
	end
	v_u_463.Changed:connect(function(p920)
		if p920 == "Text" then
			v_u_597()
		end
	end)
	v_u_471 = CreateInsertObjectMenu(GetClasses(), "", false, function(p_u_921)
		v_u_471.Visible = false
		local v_u_922 = SelectionVar():Get()
		for v_u_923 = 1, #v_u_922 do
			pcall(function()
				Instance.new(p_u_921, v_u_922[v_u_923])
			end)
		end
		DestroyRightClick()
	end)
...
spawn(function()
	wait(0.2)
	local function v_u_925(p924)
		print(tostring(p924))
	end
	game:GetService("Teams")
	game:GetService("Workspace")
	game:GetService("Debris")
	local v926 = game:GetService("ContentProvider")
	local v_u_927 = game:GetService("Players")
	game:GetService("ReplicatedStorage")
	function httpGet(p928)
		return game:HttpGet(p928, true)
	end
	...
	function getCurrentApiJson()
		...
		if readfile and getelysianpath and readfile(getelysianpath() .. "Xpl0rerApi.txt") then
			v_u_925("Api found in folder!")
			return readfile(getelysianpath() .. "Xpl0rerApi.txt")
		end
		local v930, v931 = pcall(function()
			v_u_929 = httpGet("http://anaminus.github.io/rbx/json/api/latest.json")
			v_u_925("Fetched json successfully")
		end)
		if v930 then
			v_u_925("Returning json")
			return v_u_929
		end
		v_u_925("Error fetching json: " .. tostring(v931))
		v_u_925("Falling back to local copy")
		return getLocalApiJson()
	end
	function splitStringIntoChunks(p932)
		local v933 = {}
		local v934 = string.len(p932) / 100000
		for v935 = 1, math.ceil(v934) do
			local v936 = p932:sub((v935 - 1) * 100000 + 1, v935 * 100000)
			table.insert(v933, v936)
		end
		return v933
	end
	local v937 = getCurrentApiJson()
	local v_u_938 = splitStringIntoChunks(v937)
	function getRbxApi()
		local v_u_939 = game:GetService("HttpService")
		game:GetService("ServerStorage")
		game:GetService("ReplicatedStorage")
		local function v_u_941(p940)
			if v_u_938[p940] then
				return v_u_938[p940], #v_u_938
			end
			v_u_925("Bad index for GetApiJson")
			return nil
		end
		local v948 = (function(p942)
			return v_u_939:JSONDecode(p942)
		end)(((function()
			local v943 = {}
			local v944, v945 = v_u_941(1)
			table.insert(v943, v944)
			for v946 = 2, v945 do
				local v947 = v_u_941(v946)
				table.insert(v943, v947)
			end
			return table.concat(v943)
		end)()))
		local v_u_949 = {}
		local v_u_950 = {}
		local function v_u_955(p951, p_u_952)
			table.sort(p951, function(p953, p954)
				return p953[p_u_952] < p954[p_u_952]
			end)
		end
		local function v957(p956)
			return v_u_950[p956] ~= nil
		end
		local function v962(p958)
			local v959 = v_u_949[p958]
			local v960 = {}
			if not v959 then
				return v960
			end
			while v959 do
				for _, v961 in pairs(v959.Properties) do
					table.insert(v960, v961)
				end
				v959 = v_u_949[v959.Superclass]
			end
			v_u_955(v960, "Name")
			return v960
		end
		for _, v963 in pairs(v948) do
			local v964 = v963.type
			if v964 == "Class" then
				v_u_949[v963.Name] = v963
				v963.Properties = {}
				v963.Functions = {}
				v963.YieldFunctions = {}
				v963.Events = {}
				v963.Callbacks = {}
			elseif v964 == "Property" then
				local v965 = v_u_949[v963.Class].Properties
				table.insert(v965, v963)
			elseif v964 == "Function" then
				local v966 = v_u_949[v963.Class].Functions
				table.insert(v966, v963)
			elseif v964 == "YieldFunction" then
				local v967 = v_u_949[v963.Class].YieldFunctions
				table.insert(v967, v963)
			elseif v964 == "Event" then
				local v968 = v_u_949[v963.Class].Events
				table.insert(v968, v963)
			elseif v964 == "Callback" then
				local v969 = v_u_949[v963.Class].Callbacks
				table.insert(v969, v963)
			elseif v964 == "Enum" then
				v_u_950[v963.Name] = v963
				v963.EnumItems = {}
			elseif v964 == "EnumItem" then
				v_u_950[v963.Enum].EnumItems[v963.Name] = v963
			end
		end
		return { ["Classes"] = v_u_949, ["Enums"] = v_u_950, ["GetProperties"] = v962, ["IsEnum"] = v957 }
	end
	local v_u_970 = { ["CanEdit"] = true }
	local v_u_971 = getRbxApi()
	local function v975(p972, p973, p974)
		return Color3.new(p972 / 255, p973 / 255, p974 / 255)
	end
	local v_u_976 =
		{ ["Font"] = Enum.Font.Arial, ["Margin"] = 5, ["Black"] = v975(0, 0, 0), ["White"] = v975(255, 255, 255) }
	local v_u_977 = {
		["Font"] = v_u_976.Font,
		["FontSize"] = Enum.FontSize.Size14,
		["TextXAlignment"] = Enum.TextXAlignment.Left,
		["TextColor"] = v_u_976.Black,
		["TextColorOver"] = v_u_976.White,
		["TextLockedColor"] = v975(120, 120, 120),
		["Height"] = 24,
		["BorderColor"] = v975(216, 216, 216),
		["BackgroundColor"] = v_u_976.White,
		["BackgroundColorAlternate"] = v975(246, 246, 246),
		["BackgroundColorMouseover"] = v975(211, 224, 244),
		["TitleMarginLeft"] = 15,
	}
	local v_u_978 = {
		["Font"] = v_u_976.Font,
		["FontSize"] = Enum.FontSize.Size14,
		["TextColor"] = v975(0, 0, 0),
		["TextColorOver"] = v_u_976.White,
		["TextXAlignment"] = Enum.TextXAlignment.Left,
		["Height"] = 16,
		["BackColor"] = v_u_976.White,
		["BackColorOver"] = v975(86, 125, 188),
		["BorderColor"] = v975(216, 216, 216),
		["BorderSizePixel"] = 2,
		["ArrowColor"] = v975(160, 160, 160),
		["ArrowColorOver"] = v_u_976.Black,
	}
	local v_u_979 = {
		["BoxSize"] = 13,
		["BorderSizePixel"] = 1,
		["BorderColor"] = v975(160, 160, 160),
		["FrameColor"] = v975(160, 160, 160),
		["Size"] = 20,
		["Padding"] = 4,
		["ColorsPerRow"] = 8,
		["OuterBorder"] = 1,
		["OuterBorderColor"] = v_u_976.Black,
	}
	wait(1)
	local v980 = v_u_164
	local v_u_981 = v980:WaitForChild("PropertiesFrame")
	local v982 = v980:WaitForChild("ExplorerPanel")
	local v_u_983 = v982.TotallyNotGetSelection
	local v984 = v982.TotallyNotSelectionChanged
	local v985 = v_u_981.GetApi
	local v986 = v_u_981.GetAwaiting
	local v987 = v_u_981.SetAwaiting
	local v_u_988 = v926.BaseUrl .. "asset/?id="
	local v_u_989 = v980:WaitForChild("SettingsPanel"):WaitForChild("GetSetting")
	local v_u_990 = v_u_981.Header.TextBox
	local v_u_991 = false
	local v_u_992 = nil
	local v_u_993 = nil
	function searchingProperties()
		return v_u_990.Text ~= "" and v_u_990.Text ~= "Search Properties"
	end
	local function v_u_995()
		local v994 = v_u_983:Invoke()
		if #v994 == 0 then
			return nil
		else
			return v994
	...
	local function v_u_998(p996, p997)
		return tonumber(string.format("%." .. (p997 or 0) .. "f", p996))
	end
	local function v_u_1007(p999, p1000)
		local v1001 = {}
		local v1002 = 1
		while true do
			local v1003 = string.find(p999, p1000, v1002, true)
			if not v1003 then
				break
			end
			local v1004 = v1003 - 1
			local v1005 = string.sub
			table.insert(v1001, v1005(p999, v1002, v1004))
			v1002 = v1003 + string.len(p1000)
		end
		local v1006 = string.sub
		table.insert(v1001, v1006(p999, v1002))
		return v1001
	end
	local function v_u_1023(p1008, p1009)
		if p1009 == "float" then
			return tostring(v_u_998(p1008, 2))
		end
		if p1009 == "Content" then
			if not string.find(p1008, "/asset") then
				return tostring(p1008)
			end
			local v1010 = string.find(p1008, "=") + 1
			return string.sub(p1008, v1010)
		end
		if p1009 == "Vector2" then
			local v1011 = p1008.x
			local v1012 = p1008.y
			return string.format("%g, %g", v1011, v1012)
		end
		if p1009 == "Vector3" then
			local v1013 = p1008.x
			local v1014 = p1008.y
			local v1015 = p1008.z
			return string.format("%g, %g, %g", v1013, v1014, v1015)
		end
		if p1009 == "Color3" then
			local v1016 = p1008.r
			local v1017 = p1008.g
			local v1018 = p1008.b
			return string.format("%d, %d, %d", v1016 * 255, v1017 * 255, v1018 * 255)
		end
		if p1009 ~= "UDim2" then
			return tostring(p1008)
		end
		local v1019 = p1008.X.Scale
		local v1020 = p1008.X.Offset
		local v1021 = p1008.Y.Scale
		local v1022 = p1008.Y.Offset
		return string.format("{%d, %d}, {%d, %d}", v1019, v1020, v1021, v1022)
	end
	local function v_u_1046(p1024, p1025)
		if p1025 == "Vector2" then
			local v1026 = v_u_1007(p1024, ",")
			if #v1026 < 2 then
				return nil
			end
			local v1027 = tonumber(v1026[1]) or 0
			local v1028 = tonumber(v1026[2]) or 0
			return Vector2.new(v1027, v1028)
		end
		if p1025 == "Vector3" then
			local v1029 = v_u_1007(p1024, ",")
			if #v1029 < 3 then
				return nil
			end
			local v1030 = tonumber(v1029[1]) or 0
			local v1031 = tonumber(v1029[2]) or 0
			local v1032 = tonumber(v1029[3]) or 0
			return Vector3.new(v1030, v1031, v1032)
		end
		if p1025 == "Color3" then
			local v1033 = v_u_1007(p1024, ",")
			if #v1033 < 3 then
				return nil
			end
			local v1034 = tonumber(v1033[1]) or 0
			local v1035 = tonumber(v1033[2]) or 0
			local v1036 = tonumber(v1033[3]) or 0
			return Color3.new(v1034 / 255, v1035 / 255, v1036 / 255)
		end
		if p1025 == "UDim2" then
			local v1037 = v_u_1007(string.gsub(string.gsub(p1024, "{", ""), "}", ""), ",")
			if #v1037 < 4 then
				return nil
			end
			local v1038 = tonumber(v1037[1]) or 0
			local v1039 = tonumber(v1037[2]) or 0
			local v1040 = tonumber(v1037[3]) or 0
			local v1041 = tonumber(v1037[4]) or 0
			return UDim2.new(v1038, v1039, v1040, v1041)
		end
		if p1025 == "Content" then
			if tonumber(p1024) ~= nil then
				p1024 = v_u_988 .. p1024
			end
			return p1024
		end
		if p1025 == "float" or p1025 == "int" or p1025 == "double" then
			return tonumber(p1024)
		end
		if p1025 == "string" then
			return p1024
		end
		if p1025 ~= "NumberRange" then
			return nil
		end
		local v1042 = v_u_1007(p1024, ",")
		if #v1042 == 1 then
			if tonumber(v1042[1]) == nil then
				return nil
			end
			local v1043 = tonumber(v1042[1]) or 0
			return NumberRange.new(v1043)
		end
		if #v1042 < 2 then
			return nil
		end
		local v1044 = tonumber(v1042[1]) or 0
		local v1045 = tonumber(v1042[2]) or 0
		return NumberRange.new(v1044, v1045)
	end
	local v_u_1047 = { ["Width"] = 13, ["Height"] = 13 }
	local v_u_1048 = { ["Image"] = "http://www.roblox.com/asset/?id=128896947", ["Height"] = 256, ["Width"] = 256 }
	local v_u_1049 =
		{ "unchecked", "checked", "unchecked_over", "checked_over", "unchecked_disabled", "checked_disabled" }
	local function v_u_1054(p1050)
		local v1051 = 0
		local v1052 = 0
		v1051 = 0
		v1052 = 0
		for _, v1053 in pairs(v_u_1049) do
			if v1053 == p1050 then
				return { v1052, v1051 }
			end
			v1052 = v1052 + v_u_1047.Height
			if v1052 + v_u_1047.Width > v_u_1048.Width then
				v1051 = v1051 + v_u_1047.Height
				v1052 = 0
			end
		end
	end
	local function v_u_1058(p1055, p1056, p1057)
		if p1055 then
			if p1056 then
	...
	local v_u_1059 = "http://www.roblox.com/asset/?id=" .. 418720155
	game:GetService("ContentProvider"):Preload(v_u_1059)
	local v_u_1060 = math.floor
	local function v_u_1062(p1061)
		return v_u_1060(p1061 / 14 % 14), v_u_1060(p1061 % 14)
	end
	local function v_u_1070(p1063, p1064)
		local v1065, v1066 = v_u_1062(p1064)
		local v1067 = Vector2.new(256, 256)
		local v1068
		if type(p1063) == "string" then
			v1068 = nil
		else
			v1068 = p1063
			p1063 = "Frame"
				...
				p1063,
				{
					...
					Create(
						"ImageLabel",
						{
							...
							["BackgroundTransparency"] = 1,
							["Image"] = v_u_1059,
							["Size"] = UDim2.new(v1067.x / 16, 0, v1067.y / 16, 0),
						}
					),
				}
			)
		v1069.IconMap.Position =
			UDim2.new(-v1066 - (2 * (v1066 + 1) + 1) / 16, 0, -v1065 - (2 * (v1065 + 1) + 1) / 16, 0)
		return v1069
	end
	local function v_u_1072()
		local v1071 = Instance.new("Frame")
		v1071.Size = UDim2.new(0.5, -1, 1, 0)
		v1071.BackgroundColor3 = v_u_977.BackgroundColor
		v1071.BorderColor3 = v_u_977.BorderColor
		return v1071
	end
	local function v_u_1075(p1073)
		local v1074 = Instance.new("TextLabel")
		v1074.Font = v_u_977.Font
		v1074.FontSize = v_u_977.FontSize
		v1074.TextXAlignment = v_u_977.TextXAlignment
		v1074.BackgroundTransparency = 1
		if p1073 then
			v1074.TextColor3 = v_u_977.TextLockedColor
			return v1074
		else
			v1074.TextColor3 = v_u_977.TextColor
			return v1074
		end
	end
	local function v_u_1079(p1076, p_u_1077)
		local v1078 = Instance.new("TextButton")
		v1078.Font = v_u_977.Font
		v1078.FontSize = v_u_977.FontSize
		v1078.TextXAlignment = v_u_977.TextXAlignment
		v1078.BackgroundTransparency = 1
		if p1076 then
			v1078.TextColor3 = v_u_977.TextLockedColor
			return v1078
		end
		v1078.TextColor3 = v_u_977.TextColor
		v1078.MouseButton1Click:connect(function()
			p_u_1077()
		end)
		return v1078
	end
	local function v_u_1082(p1080)
		local v1081 = Instance.new("TextButton")
		v1081.Font = v_u_977.Font
		v1081.FontSize = v_u_977.FontSize
		v1081.TextXAlignment = v_u_977.TextXAlignment
		v1081.BackgroundTransparency = 1
		if p1080 then
			v1081.TextColor3 = v_u_977.TextLockedColor
		else
			v1081.TextColor3 = v_u_977.TextColor
		end
		Create(
			v_u_1070("ImageButton", 177),
			{
				["Name"] = "Cancel",
				["Visible"] = false,
	...
	local function v_u_1085(p1083)
		if p1083 then
			return v_u_1075(p1083)
		end
		local v1084 = Instance.new("TextBox")
		if not v_u_989:Invoke("ClearProps") then
			v1084.ClearTextOnFocus = false
		end
		v1084.Font = v_u_977.Font
		v1084.FontSize = v_u_977.FontSize
		v1084.TextXAlignment = v_u_977.TextXAlignment
		v1084.BackgroundTransparency = 1
		v1084.TextColor3 = v_u_977.TextColor
		return v1084
	end
	local function v_u_1089(p_u_1086, p_u_1087)
		local v_u_1088 = Instance.new("TextButton")
		v_u_1088.Font = v_u_978.Font
		v_u_1088.FontSize = v_u_978.FontSize
		v_u_1088.TextColor3 = v_u_978.TextColor
		v_u_1088.TextXAlignment = v_u_978.TextXAlignment
		v_u_1088.BackgroundColor3 = v_u_978.BackColor
		v_u_1088.AutoButtonColor = false
		v_u_1088.BorderSizePixel = 0
		v_u_1088.Active = true
		v_u_1088.Text = p_u_1086
		v_u_1088.MouseEnter:connect(function()
			v_u_1088.TextColor3 = v_u_978.TextColorOver
			v_u_1088.BackgroundColor3 = v_u_978.BackColorOver
		end)
		v_u_1088.MouseLeave:connect(function()
			v_u_1088.TextColor3 = v_u_978.TextColor
			v_u_1088.BackgroundColor3 = v_u_978.BackColor
		end)
		v_u_1088.MouseButton1Click:connect(function()
			p_u_1087(p_u_1086)
		end)
		return v_u_1088
	end
	local function v_u_1113(p_u_1090, p1091, p1092, p_u_1093)
		local v_u_1094 = Instance.new("Frame")
		v_u_1094.Name = "DropDown"
		v_u_1094.Size = UDim2.new(1, 0, 1, 0)
		v_u_1094.BackgroundTransparency = 1
		v_u_1094.Active = true
		local v_u_1095 = nil
		local v_u_1096 = nil
		local v_u_1097 = false
		local v_u_1098 = v_u_978.BorderSizePixel
		local v_u_1099 = Instance.new("TextButton")
		v_u_1099.Font = v_u_977.Font
		v_u_1099.FontSize = v_u_977.FontSize
		v_u_1099.TextXAlignment = v_u_977.TextXAlignment
		v_u_1099.BackgroundTransparency = 1
		v_u_1099.TextColor3 = v_u_977.TextColor
		if p1092 then
			v_u_1099.TextColor3 = v_u_977.TextLockedColor
		end
		v_u_1099.Text = p1091
		v_u_1099.Size = UDim2.new(1, -2 * v_u_976.Margin, 1, 0)
		v_u_1099.Position = UDim2.new(0, v_u_976.Margin, 0, 0)
		v_u_1099.Parent = v_u_1094
		local function v_u_1102(p1100)
			if v_u_1096 then
				v_u_1096:Destroy()
			end
			local v1101 =
				Create("Frame", { ["Name"] = "Graphic", ["BorderSizePixel"] = 0, ["BackgroundColor3"] = p1100 })
			v_u_1096 = ArrowGraphic(8, "Down", true, v1101)
			v_u_1096.Position = UDim2.new(1, -16, 0.5, -4)
			v_u_1096.Parent = v_u_1094
		end
		local function v_u_1103()
			v_u_1097 = false
			v_u_1102(v_u_978.ArrowColor)
			if v_u_1095 then
				v_u_1095:Destroy()
			end
		end
		local function v_u_1112()
			v_u_1097 = true
			v_u_1095 = Instance.new("Frame")
			v_u_1095.Size = UDim2.new(1, -2 * v_u_1098, 0, #p_u_1090 * v_u_978.Height)
			v_u_1095.Position = UDim2.new(0, v_u_1098, 0, v_u_977.Height + v_u_1098)
			v_u_1095.BackgroundTransparency = 0
			v_u_1095.BackgroundColor3 = v_u_978.BackColor
			v_u_1095.BorderColor3 = v_u_978.BorderColor
			v_u_1095.BorderSizePixel = v_u_978.BorderSizePixel
			v_u_1095.Active = true
			v_u_1095.ZIndex = 5
			v_u_1095.Parent = v_u_1094
			local v1104 = v_u_1095.Parent.Parent.Parent.Parent.Size.Y.Offset
			local v1105 = v_u_1095.Parent.Parent.Parent.Position.Y.Offset + v_u_1095.Size.Y.Offset
			local v1106 = v_u_981.AbsoluteSize.y
			if math.max(v1104, v1106) < v1105 then
				v_u_1095.Position = UDim2.new(0, v_u_1098, 0, -1 * #p_u_1090 * v_u_978.Height - v_u_1098)
			end
			local function v_u_1108(p1107)
				p_u_1093(p1107)
				v_u_1103()
			end
			for v1109, v_u_1110 in pairs(p_u_1090) do
				local v1111 = v_u_1089(v_u_1110, function()
					v_u_1108(v_u_1110)
				end)
				v1111.Size = UDim2.new(1, 0, 0, 16)
				v1111.Position = UDim2.new(0, 0, 0, (v1109 - 1) * v_u_978.Height)
				v1111.ZIndex = v_u_1095.ZIndex
				v1111.Parent = v_u_1095
			end
		end
		v_u_1102(v_u_978.ArrowColor)
		if not p1092 then
			v_u_1099.MouseEnter:connect(function()
				v_u_1099.TextColor3 = v_u_977.TextColor
				v_u_1102(v_u_978.ArrowColorOver)
			end)
			v_u_1099.MouseLeave:connect(function()
				v_u_1099.TextColor3 = v_u_977.TextColor
				if not v_u_1097 then
					v_u_1102(v_u_978.ArrowColor)
				end
			end)
			v_u_1099.MouseButton1Click:connect(function()
				if v_u_1097 then
					v_u_1103()
				else
					v_u_1112()
		...
		return v_u_1094, v_u_1099
	end
	local function v_u_1131(p_u_1114, p_u_1115)
		local v1116 = Instance.new("Frame")
		v1116.Size = UDim2.new(1, 0, 1, 0)
		v1116.BackgroundTransparency = 1
		local v_u_1117 = Instance.new("Frame")
		v_u_1117.BackgroundTransparency = 0
		v_u_1117.SizeConstraint = Enum.SizeConstraint.RelativeXX
		v_u_1117.Size = UDim2.new(1, -2 * v_u_979.OuterBorder, 1, -2 * v_u_979.OuterBorder)
		v_u_1117.BorderSizePixel = v_u_979.BorderSizePixel
		v_u_1117.BorderColor3 = v_u_979.BorderColor
		v_u_1117.Position = UDim2.new(0, v_u_979.OuterBorder, 0, v_u_979.OuterBorder + v_u_977.Height)
		v_u_1117.ZIndex = 5
		v_u_1117.Visible = false
		v_u_1117.BorderSizePixel = v_u_979.OuterBorder
		v_u_1117.BorderColor3 = v_u_979.OuterBorderColor
		v_u_1117.Parent = v1116
		local function v_u_1118()
			v_u_1117.Visible = false
		end
		local function v_u_1119()
			v_u_1117.Visible = not v_u_1117.Visible
		end
		local v1120 = Instance.new("TextButton", v1116)
		v1120.Position = UDim2.new(0, v_u_976.Margin, 0, v_u_976.Margin)
		v1120.Size = UDim2.new(0, v_u_979.BoxSize, 0, v_u_979.BoxSize)
		v1120.Text = ""
		v1120.MouseButton1Click:connect(function()
			if not p_u_1114 then
				v_u_1119()
			end
		end)
		if p_u_1114 then
			v1120.AutoButtonColor = false
		end
		local v1121 = v_u_976.Margin * 2 + v_u_979.BoxSize
		local v1122 = v_u_1079(p_u_1114, function()
			if not p_u_1114 then
				v_u_1119()
			end
		end)
		v1122.Size = UDim2.new(1, -1 * v1121 - v_u_976.Margin, 1, 0)
		v1122.Position = UDim2.new(0, v1121, 0, 0)
		v1122.Parent = v1116
		local v1123 = 1 / v_u_979.ColorsPerRow
		for v1124 = 0, 127 do
			local v_u_1125 = BrickColor.palette(v1124)
			local v1126 = v_u_1125.Color
			local v1127 = v1123 * v1124 % v_u_979.ColorsPerRow
			local v1128 = v1124 / v_u_979.ColorsPerRow
			local v1129 = v1123 * math.floor(v1128)
			local v1130 = Instance.new("TextButton")
			v1130.Text = ""
			v1130.Size = UDim2.new(v1123, 0, v1123, 0)
			v1130.BackgroundColor3 = v1126
			v1130.Position = UDim2.new(v1127, 0, v1129, 0)
			v1130.ZIndex = v_u_1117.ZIndex
			v1130.Parent = v_u_1117
			v1130.MouseButton1Click:connect(function()
				v_u_1118()
				p_u_1115(v_u_1125)
			end)
		end
		return v1116, v1122, v1120
	end
	local function v_u_1137(p1132, _)
		local v1133 = Instance.new("Frame")
		v1133.Size = UDim2.new(1, 0, 1, 0)
		v1133.BackgroundTransparency = 1
		local v1134 = Instance.new("TextButton", v1133)
		v1134.Position = UDim2.new(0, v_u_976.Margin, 0, v_u_976.Margin)
		v1134.Size = UDim2.new(0, v_u_979.BoxSize, 0, v_u_979.BoxSize)
		v1134.Text = ""
		v1134.AutoButtonColor = false
		local v1135 = v_u_976.Margin * 2 + v_u_979.BoxSize
		local v1136 = v_u_1085(p1132)
		v1136.Size = UDim2.new(1, -1 * v1135 - v_u_976.Margin, 1, 0)
		v1136.Position = UDim2.new(0, v1135, 0, 0)
		v1136.Parent = v1133
		return v1133, v1136, v1134
	end
	function CreateCheckbox(p1138, p_u_1139, p_u_1140)
		local v_u_1141 = p1138
		local v_u_1142 = false
		local v1143 = Instance.new("ImageButton")
		v1143.Size = UDim2.new(0, v_u_1047.Width, 0, v_u_1047.Height)
		v1143.BackgroundTransparency = 1
		v1143.ClipsDescendants = true
		local v_u_1144 = Instance.new("ImageLabel", v1143)
		v_u_1144.Name = "SpritesheetImageLabel"
		v_u_1144.Size = UDim2.new(0, v_u_1048.Width, 0, v_u_1048.Height)
		v_u_1144.Image = v_u_1048.Image
		v_u_1144.BackgroundTransparency = 1
		local function v_u_1146()
			local v1145 = v_u_1054((v_u_1058(v_u_1141, p_u_1139, v_u_1142)))
			v_u_1144.Position = UDim2.new(0, -1 * v1145[1], 0, -1 * v1145[2])
		end
		local function v1148(p1147)
			v_u_1141 = p1147
			v_u_1146()
		end
		if not p_u_1139 then
			v1143.MouseEnter:connect(function()
				v_u_1142 = true
				v_u_1146()
			end)
			v1143.MouseLeave:connect(function()
				v_u_1142 = false
				v_u_1146()
			end)
			v1143.MouseButton1Click:connect(function()
				p_u_1140(v_u_1141)
			end)
		end
		v_u_1146()
	...
	local v_u_1211 = {
		["default"] = function(p_u_1149, p_u_1150, p1151)
			local v_u_1152 = p_u_1150.Name
			local v_u_1153 = p_u_1150.ValueType
			local v_u_1154 = v_u_1085(p1151)
			v_u_1154.Size = UDim2.new(1, -2 * v_u_976.Margin, 1, 0)
			v_u_1154.Position = UDim2.new(0, v_u_976.Margin, 0, 0)
			local function v_u_1155()
				v_u_1154.Text = v_u_1023(p_u_1149[v_u_1152], v_u_1153)
			end
			if not p1151 then
				v_u_1154.FocusLost:connect(function(_)
					Set(p_u_1149, p_u_1150, v_u_1046(v_u_1154.Text, v_u_1153))
					v_u_1155()
				end)
			end
			v_u_1155()
			p_u_1149.Changed:connect(function(p1156)
				if p1156 == v_u_1152 then
					v_u_1155()
				end
			end)
			return v_u_1154
		end,
		["bool"] = function(p_u_1157, p_u_1158, p1159)
			local v_u_1160 = p_u_1158.Name
			local v_u_1161 = p_u_1157[v_u_1160]
			local v1162, v_u_1163 = CreateCheckbox(v_u_1161, p1159, function(_)
				Set(p_u_1157, p_u_1158, not v_u_1161)
			end)
			v1162.Position = UDim2.new(0, v_u_976.Margin, 0, v_u_976.Margin)
			v_u_1163(v_u_1161)
			local function v_u_1164()
				v_u_1161 = p_u_1157[v_u_1160]
				v_u_1163(v_u_1161)
			end
			p_u_1157.Changed:connect(function(p1165)
				if p1165 == v_u_1160 then
					v_u_1164()
				end
			end)
			if p_u_1157:IsA("BoolValue") then
				p_u_1157.Changed:connect(function(_)
					v_u_1164()
				end)
			end
			v_u_1164()
		...
		["BrickColor"] = function(p_u_1166, p_u_1167, p1168)
			local v_u_1169 = p_u_1167.Name
			local v1171, v_u_1172, v_u_1173 = v_u_1131(p1168, function(p1170)
				Set(p_u_1166, p_u_1167, p1170)
			end)
			local function v_u_1175()
				local v1174 = p_u_1166[v_u_1169]
				v_u_1173.BackgroundColor3 = v1174.Color
				v_u_1172.Text = tostring(v1174)
			end
			v_u_1175()
			p_u_1166.Changed:connect(function(p1176)
				if p1176 == v_u_1169 then
					v_u_1175()
				end
			end)
			return v1171
		end,
		["Color3"] = function(p_u_1177, p_u_1178, p1179)
			local v_u_1180 = p_u_1178.Name
			local v1181, v_u_1182, v_u_1183 = v_u_1137(p1179)
			v_u_1182.FocusLost:connect(function(_)
				Set(p_u_1177, p_u_1178, v_u_1046(v_u_1182.Text, "Color3"))
				local v1184 = p_u_1177[v_u_1180]
				v_u_1183.BackgroundColor3 = v1184
				v_u_1182.Text = v_u_1023(v1184, "Color3")
			end)
			local function v_u_1186()
				local v1185 = p_u_1177[v_u_1180]
				v_u_1183.BackgroundColor3 = v1185
				v_u_1182.Text = v_u_1023(v1185, "Color3")
			end
			v_u_1186()
			p_u_1177.Changed:connect(function(p1187)
				if p1187 == v_u_1180 then
					v_u_1186()
				end
			end)
			return v1181
		end,
		["Enum"] = function(p_u_1188, p_u_1189, p1190)
			local v_u_1191 = p_u_1189.Name
			local v1192 = p_u_1189.ValueType
			local v1193 = p_u_1188[v_u_1191].Name
			local v1194 = {}
			for _, v1195 in pairs(Enum[tostring(v1192)]:GetEnumItems()) do
				local v1196 = v1195.Name
				table.insert(v1194, v1196)
			end
			local v1198, v_u_1199 = v_u_1113(v1194, v1193, p1190, function(p1197)
				Set(p_u_1188, p_u_1189, p1197)
			end)
			local function v_u_1201()
				local v1200 = p_u_1188[v_u_1191].Name
				v_u_1199.Text = tostring(v1200)
			end
			v_u_1201()
			p_u_1188.Changed:connect(function(p1202)
				if p1202 == v_u_1191 then
					v_u_1201()
				end
			end)
			return v1198
		end,
		["Object"] = function(p_u_1203, p_u_1204, p1205)
			local v_u_1206 = p_u_1204.Name
			local v_u_1207 = p_u_1204.ValueType
			local v_u_1208 = v_u_1082(p1205, function() end)
			v_u_1208.Size = UDim2.new(1, -2 * v_u_976.Margin, 1, 0)
			v_u_1208.Position = UDim2.new(0, v_u_976.Margin, 0, 0)
			local function v_u_1209()
				if v_u_992 == p_u_1203 and v_u_991 == true then
					v_u_1208.Text = "Select an Object"
				else
					v_u_1208.Text = v_u_1023(p_u_1203[v_u_1206], v_u_1207)
				end
			end
			if not p1205 then
				v_u_1208.MouseButton1Click:connect(function()
					if v_u_991 then
						v_u_991 = false
						v_u_1209()
					else
				...
				v_u_1208.Cancel.Visible = true
				v_u_1208.Cancel.MouseButton1Click:connect(function()
					p_u_1203[v_u_1206] = nil
				end)
			end
			v_u_1209()
			p_u_1203.Changed:connect(function(p1210)
				if p1210 == v_u_1206 then
					v_u_1209()
				end
			end)
			if p_u_1203:IsA("ObjectValue") then
				p_u_1203.Changed:connect(function(_)
					v_u_1209()
				end)
			end
			return v_u_1208
	...
	function GetControl(p1212, p1213, p1214)
		local v1215 = p1213.ValueType
		if v_u_1211[v1215] then
			return v_u_1211[v1215](p1212, p1213, p1214)
		elseif v_u_971.IsEnum(v1215) then
			return v_u_1211.Enum(p1212, p1213, p1214)
		else
			return v_u_1211.default(p1212, p1213, p1214)
		end
	end
	function CanEditObject(_)
		local _ = v_u_927.LocalPlayer.Character
		return v_u_970.CanEdit
	end
	function CanEditProperty(p1216, p1217)
		local v1218 = p1217.tags
		for _, v1219 in pairs(v1218) do
			if v1219 == "readonly" then
				return false
			end
		end
		return CanEditObject(p1216)
	end
	local function v_u_1223(p1220)
		local v1221 = p1220.tags
		for _, v1222 in pairs(v1221) do
			if v1222 == "deprecated" or v1222 == "hidden" or v1222 == "writeonly" then
				return true
			end
		end
		return false
		...
		if p_u_1225 == nil then
			...
			for _, v_u_1227 in pairs(v_u_995()) do
				if CanEditProperty(v_u_1227, p1224) then
					pcall(function()
						v_u_1227[v_u_1226] = p_u_1225
					end)
				end
			end
		end
	end
	function CreateRow(p1228, p1229, p1230)
		local v1231 = p1229.Name
		local v1232 = p1229.ValueType
		local _ = p1228[v1231]
		local v_u_1233 = v_u_977.BackgroundColor
		if p1230 then
			v_u_1233 = v_u_977.BackgroundColorAlternate
		end
		local v1234 = not CanEditProperty(p1228, p1229)
		if v1232 == "Instance" or v1231 == "Parent" then
			v1234 = true
		end
		local v1235 = Instance.new("Frame")
		v1235.Size = UDim2.new(1, 0, 0, v_u_977.Height)
		v1235.BackgroundTransparency = 1
		v1235.Name = "Row"
		local v_u_1236 = v_u_1072()
		v_u_1236.Parent = v1235
		v_u_1236.ClipsDescendants = true
		local v1237 = v_u_1075(v1234)
		v1237.Text = v1231
		v1237.Size = UDim2.new(1, -1 * v_u_977.TitleMarginLeft, 1, 0)
		v1237.Position = UDim2.new(0, v_u_977.TitleMarginLeft, 0, 0)
		v1237.Parent = v_u_1236
		local v_u_1238 = v_u_1072()
		v_u_1238.Size = UDim2.new(0.5, -1, 1, 0)
		v_u_1238.Position = UDim2.new(0.5, 0, 0, 0)
		v_u_1238.Parent = v1235
		GetControl(p1228, p1229, v1234).Parent = v_u_1238
		v1235.MouseEnter:connect(function()
			v_u_1236.BackgroundColor3 = v_u_977.BackgroundColorMouseover
			v_u_1238.BackgroundColor3 = v_u_977.BackgroundColorMouseover
		end)
		v1235.MouseLeave:connect(function()
			v_u_1236.BackgroundColor3 = v_u_1233
			v_u_1238.BackgroundColor3 = v_u_1233
		end)
		v_u_1236.BackgroundColor3 = v_u_1233
		v_u_1238.BackgroundColor3 = v_u_1233
		return v1235
	...
	function ClearPropertiesList()
		for _, v1239 in pairs(ContentFrame:GetChildren()) do
			v1239:Destroy()
		end
	end
	v_u_925((v980:FindFirstChild("Selection", 1)))
	function displayProperties(p1240)
		for _, v_u_1241 in pairs(p1240) do
			pcall(function()
				local v1242 = CreateRow(v_u_1241.object, v_u_1241.propertyData, numRows % 2 == 0)
				v1242.Position = UDim2.new(0, 0, 0, numRows * v_u_977.Height)
				v1242.Parent = ContentFrame
				numRows = numRows + 1
			end)
		end
	end
	function checkForDupe(p1243, p1244)
		for _, v1245 in pairs(p1244) do
			if v1245.propertyData.Name == p1243.Name and v1245.propertyData.ValueType == p1243.ValueType then
				return true
			end
		end
		return false
	end
	function sortProps(p1246)
		table.sort(p1246, function(p1247, p1248)
			return p1247.propertyData.Name < p1248.propertyData.Name
		end)
	end
	function showProperties(p1249)
		...
		if p1249 == nil then
			...
			local v1251 = {}
			numRows = 0
			for _, v_u_1252 in pairs(p1249) do
				if not v1251[v_u_1252.className] then
					v1251[v_u_1252.className] = true
					for _, v_u_1253 in pairs(v_u_971.GetProperties(v_u_1252.className)) do
						local _, _ = pcall(function()
							if
								not v_u_1223(v_u_1253)
								and not checkForDupe(v_u_1253, v_u_1250)
								and (
									string.find(string.lower(v_u_1253.Name), string.lower(v_u_990.Text))
									or not searchingProperties()
								)
							then
								table.insert(v_u_1250, { ["propertyData"] = v_u_1253, ["object"] = v_u_1252 })
							end
						end)
					end
				end
			...
			sortProps(v_u_1250)
			displayProperties(v_u_1250)
			ContentFrame.Size = UDim2.new(1, 0, 0, numRows * v_u_977.Height)
			scrollBar.ScrollIndex = 0
			scrollBar.TotalSpace = numRows * v_u_977.Height
			scrollBar.Update()
		end
	end
	local v_u_1254 = {
	...
	local v_u_1255 = {}
	function SetZIndex(p1256, p1257)
		if not v_u_1255[p1256] then
			v_u_1255[p1256] = true
			if p1256:IsA("GuiObject") then
				p1256.ZIndex = p1257
			end
			local v1258 = p1256:GetChildren()
			for v1259 = 1, #v1258 do
				SetZIndex(v1258[v1259], p1257)
			end
			v_u_1255[p1256] = nil
		end
	end
	function SetZIndexOnChanged(p_u_1260)
		return p_u_1260.Changed:connect(function(p1261)
			if p1261 == "ZIndex" then
				SetZIndex(p_u_1260, p_u_1260.ZIndex)
			end
		end)
	end
	function Create(p1262, p1263)
		if type(p1262) == "string" then
			p1262 = Instance.new(p1262)
		end
		for v1264, v1265 in pairs(p1263) do
			if type(v1264) == "number" then
				v1265.Parent = p1262
			else
				p1262[v1264] = v1265
			end
	...
	function GetScreen(p1266)
		if p1266 == nil then
			return nil
		end
		while not p1266:IsA("ScreenGui") do
			p1266 = p1266.Parent
			if p1266 == nil then
				return nil
			end
	...
	function ResetButtonColor(p1267)
		local v1268 = p1267.Active
		p1267.Active = not v1268
		p1267.Active = v1268
	end
	function ArrowGraphic(p_u_1269, p1270, p1271, p1272)
		local v1273 = Create(
			"Frame",
			{
				["Name"] = "Arrow Graphic",
				["BorderSizePixel"] = 0,
				["Size"] = UDim2.new(0, p_u_1269, 0, p_u_1269),
				["Transparency"] = 1,
			}
		)
		if not p1272 then
			p1272 = Instance.new("Frame")
			p1272.BorderSizePixel = 0
		end
		local v1274 = nil
		if p1270 == nil or p1270 == "Up" then
			v1274 = function(p1275, p1276)
				return p1275, p1276
			end
		elseif p1270 == "Down" then
			v1274 = function(p1277, p1278)
				return UDim2.new(0, p1277.X.Offset, 0, p_u_1269 - p1277.Y.Offset - 1), p1278
			end
		elseif p1270 == "Left" then
			v1274 = function(p1279, p1280)
				return UDim2.new(0, p1279.Y.Offset, 0, p1279.X.Offset), UDim2.new(0, p1280.Y.Offset, 0, p1280.X.Offset)
			end
		elseif p1270 == "Right" then
			v1274 = function(p1281, p1282)
				return UDim2.new(0, p_u_1269 - p1281.Y.Offset - 1, 0, p1281.X.Offset),
					UDim2.new(0, p1282.Y.Offset, 0, p1282.X.Offset)
			end
		end
		local v1283
		if p1271 then
			v1283 = function(p1284, p1285)
				return UDim2.new(p1284.X.Offset / p_u_1269, 0, p1284.Y.Offset / p_u_1269, 0),
					UDim2.new(p1285.X.Offset / p_u_1269, 0, p1285.Y.Offset / p_u_1269, 0)
			end
		else
			v1283 = function(p1286, p1287)
				return p1286, p1287
			end
		end
		local v1288 = p_u_1269 / 4
		local v1289 = math.floor(v1288)
		if p_u_1269 % 2 == 0 then
			local v1290 = p_u_1269 / 2 - 1
			for v1291 = 0, v1290 do
				local v1292 = p1272:Clone()
				local v1293, v1294 =
					v1283(v1274(UDim2.new(0, v1290 - v1291, 0, v1289 + v1291), UDim2.new(0, (v1291 + 1) * 2, 0, 1)))
				v1292.Position = v1293
				v1292.Size = v1294
				v1292.Parent = v1273
			end
		else
			local v1295 = (p_u_1269 - 1) / 2
			for v1296 = 0, v1295 do
				local v1297 = p1272:Clone()
				local v1298, v1299 =
					v1283(v1274(UDim2.new(0, v1295 - v1296, 0, v1289 + v1296), UDim2.new(0, v1296 * 2 + 1, 0, 1)))
				v1297.Position = v1298
				v1297.Size = v1299
				v1297.Parent = v1273
			end
		end
		if 1 < p_u_1269 % 4 then
			local v1300 = p1272:Clone()
			local v1301, v1302 = v1283(v1274(UDim2.new(0, 0, 0, p_u_1269 - v1289 - 1), UDim2.new(0, p_u_1269, 0, 1)))
			v1300.Position = v1301
			v1300.Size = v1302
			v1300.Parent = v1273
		end
		return v1273
	end
	function GripGraphic(p_u_1303, p1304, p1305, p1306, p1307)
		local v1308 = Create(
			"Frame",
			{
				["Name"] = "Grip Graphic",
				["BorderSizePixel"] = 0,
				["Size"] = UDim2.new(0, p_u_1303.x, 0, p_u_1303.y),
				["Transparency"] = 1,
			}
		)
		if not p1307 then
			p1307 = Instance.new("Frame")
			p1307.BorderSizePixel = 0
		end
		local v1309 = p1305 or 2
		local v1310
		if p1306 then
			v1310 = function(p1311)
				return UDim2.new(p1311.X.Offset / p_u_1303.x, 0, p1311.Y.Offset / p_u_1303.y, 0)
			end
		else
			v1310 = function(p1312)
				return p1312
			end
		end
		if p1304 == "Vertical" then
			for v1313 = 0, p_u_1303.x - 1, v1309 do
				local v1314 = p1307:Clone()
				v1314.Size = v1310(UDim2.new(0, 1, 0, p_u_1303.y))
				v1314.Position = v1310(UDim2.new(0, v1313, 0, 0))
				v1314.Parent = v1308
			end
			return v1308
		else
			if p1304 == nil or p1304 == "Horizontal" then
				for v1315 = 0, p_u_1303.y - 1, v1309 do
					local v1316 = p1307:Clone()
					v1316.Size = v1310(UDim2.new(0, p_u_1303.x, 0, 1))
					v1316.Position = v1310(UDim2.new(0, 0, 0, v1315))
					v1316.Parent = v1308
				end
			end
			return v1308
	...
	local v_u_1327 = {
		["__index"] = {
			["GetScrollPercent"] = function(p1317)
				return p1317.ScrollIndex / (p1317.TotalSpace - p1317.VisibleSpace)
			end,
			["CanScrollDown"] = function(p1318)
				return p1318.ScrollIndex + p1318.VisibleSpace < p1318.TotalSpace
			end,
			["CanScrollUp"] = function(p1319)
				return 0 < p1319.ScrollIndex
			end,
			["ScrollDown"] = function(p1320)
				p1320.ScrollIndex = p1320.ScrollIndex + p1320.PageIncrement
				p1320:Update()
			end,
			["ScrollUp"] = function(p1321)
				p1321.ScrollIndex = p1321.ScrollIndex - p1321.PageIncrement
				p1321:Update()
			end,
			["ScrollTo"] = function(p1322, p1323)
				p1322.ScrollIndex = p1323
				p1322:Update()
			end,
			["SetScrollPercent"] = function(p1324, p1325)
				local v1326 = (p1324.TotalSpace - p1324.VisibleSpace) * p1325 + 0.5
				p1324.ScrollIndex = math.floor(v1326)
				p1324:Update()
			end,
		},
	}
	v_u_1327.__index.CanScrollRight = v_u_1327.__index.CanScrollDown
	v_u_1327.__index.CanScrollLeft = v_u_1327.__index.CanScrollUp
	v_u_1327.__index.ScrollLeft = v_u_1327.__index.ScrollUp
	v_u_1327.__index.ScrollRight = v_u_1327.__index.ScrollDown
	function ScrollBar(p1328)
		local v_u_1329 = Create(
			"Frame",
			{
				["Name"] = "ScrollFrame",
				["Position"] = p1328 and UDim2.new(0, 0, 1, -16) or UDim2.new(1, -16, 0, 0),
				["Size"] = p1328 and UDim2.new(1, 0, 0, 16) or UDim2.new(0, 16, 1, 0),
				["BackgroundTransparency"] = 1,
				Create(
					"ImageButton",
					{
						["Name"] = "ScrollDown",
						["Position"] = p1328 and UDim2.new(1, -16, 0, 0) or UDim2.new(0, 0, 1, -16),
						["Size"] = UDim2.new(0, 16, 0, 16),
						["BackgroundColor3"] = v_u_1254.Button,
						["BorderColor3"] = v_u_1254.Border,
					}
				),
				Create(
					"ImageButton",
				...
				Create(
					...
					{
						["Name"] = "ScrollBar",
						["Size"] = p1328 and UDim2.new(1, -32, 1, 0) or UDim2.new(1, 0, 1, -32),
						["Position"] = p1328 and UDim2.new(0, 16, 0, 0) or UDim2.new(0, 0, 0, 16),
						["AutoButtonColor"] = false,
						["BackgroundColor3"] = Color3.new(0.94902, 0.94902, 0.94902),
						["BorderColor3"] = v_u_1254.Border,
						Create(
		...
		local v1330 =
			Create("Frame", { ["Name"] = "Graphic", ["BorderSizePixel"] = 0, ["BackgroundColor3"] = v_u_1254.Border })
		local v_u_1331 = v_u_1329.ScrollDown
		local v1332 = ArrowGraphic
		local v1333 = 8
		local v1334
		if p1328 then
			v1334 = "Right"
		...
		local v_u_1335 = v1332(v1333, v1334, true, v1330)
		v_u_1335.Position = UDim2.new(0.5, -4, 0.5, -4)
		v_u_1335.Parent = v_u_1331
		local v_u_1336 = v_u_1329.ScrollUp
		local v1337 = ArrowGraphic
		local v1338 = 8
		local v1339
		if p1328 then
			v1339 = "Left"
		...
		local v_u_1340 = v1337(v1338, v1339, true, v1330)
		v_u_1340.Position = UDim2.new(0.5, -4, 0.5, -4)
		v_u_1340.Parent = v_u_1336
		local v_u_1341 = v_u_1329.ScrollBar
		local v_u_1342 = v_u_1341.ScrollThumb
		local v1343 = GripGraphic
		local v1344 = Vector2.new(6, 6)
		local v1345
		if p1328 then
			v1345 = "Vertical"
		else
		...
		local v1346 = v1343(v1344, v1345, 2, v1330)
		v1346.Position = UDim2.new(0.5, -3, 0.5, -3)
		v1346.Parent = v_u_1342
		local v_u_1347 = Create(
			"ImageButton",
			{
				["Name"] = "MouseDrag",
				["Position"] = UDim2.new(-0.25, 0, -0.25, 0),
		...
		local v_u_1348 = setmetatable(
			{ ["GUI"] = v_u_1329, ["ScrollIndex"] = 0, ["VisibleSpace"] = 0, ["TotalSpace"] = 0, ["PageIncrement"] = 1 },
			v_u_1327
		)
		local v_u_1349
		if p1328 then
			v_u_1349 = function()
				v_u_1342.Size = UDim2.new(v_u_1348.VisibleSpace / v_u_1348.TotalSpace, 0, 0, 16)
				if v_u_1342.AbsoluteSize.x < 16 then
					v_u_1342.Size = UDim2.new(0, 16, 0, 16)
				end
				local v1350 = v_u_1341.AbsoluteSize.x
				v_u_1342.Position =
					UDim2.new(v_u_1348:GetScrollPercent() * (v1350 - v_u_1342.AbsoluteSize.x) / v1350, 0, 0, 0)
			end
		else
			v_u_1349 = function()
				v_u_1342.Size = UDim2.new(0, 16, v_u_1348.VisibleSpace / v_u_1348.TotalSpace, 0)
				if v_u_1342.AbsoluteSize.y < 16 then
					v_u_1342.Size = UDim2.new(0, 16, 0, 16)
				end
				local v1351 = v_u_1341.AbsoluteSize.y
				v_u_1342.Position =
					UDim2.new(0, 0, v_u_1348:GetScrollPercent() * (v1351 - v_u_1342.AbsoluteSize.y) / v1351, 0)
			end
		end
		local v_u_1352 = nil
		local v_u_1353 = nil
		local v_u_1354 = { ["BackgroundColor3"] = v_u_1254.Border, ["BackgroundTransparency"] = 0 }
		local v_u_1355 = { ["BackgroundColor3"] = v_u_1254.Border, ["BackgroundTransparency"] = 0.7 }
		local function v1367()
			local v1356 = v_u_1348.TotalSpace
			local v1357 = v_u_1348.VisibleSpace
			local v1358 = v_u_1348.ScrollIndex
			if v1357 <= v1356 then
				if 0 < v1358 then
					if v1356 < v1358 + v1357 then
						v_u_1348.ScrollIndex = v1356 - v1357
					end
				else
			...
			if v_u_1348.UpdateCallback and v_u_1348.UpdateCallback(v_u_1348) == false then
				...
				if v1359 ~= v_u_1352 then
					v_u_1352 = v1359
					v_u_1331.Active = v1359
					v_u_1331.AutoButtonColor = v1359
					local v1361 = v_u_1335:GetChildren()
					local v1362 = v1359 and v_u_1354
					if not v1362 then
						v1362 = v_u_1355
					end
					for v1363 = 1, #v1361 do
						Create(v1361[v1363], v1362)
					end
				end
				if v1360 ~= v_u_1353 then
					v_u_1353 = v1360
					v_u_1336.Active = v1360
					v_u_1336.AutoButtonColor = v1360
					local v1364 = v_u_1340:GetChildren()
					local v1365 = v1360 and v_u_1354
					if not v1365 then
						v1365 = v_u_1355
					end
					for v1366 = 1, #v1364 do
						Create(v1364[v1366], v1365)
					end
				end
				v_u_1342.Visible = v1359 or v1360
				v_u_1349()
			end
		end
		v_u_1348.Update = v1367
		SetZIndexOnChanged(v_u_1329)
		local v_u_1368 = 0
		v_u_1331.MouseButton1Down:connect(function()
			v_u_1368 = tick()
			local v1369 = v_u_1368
			local v_u_1370 = nil
			v_u_1370 = v_u_1347.MouseButton1Up:connect(function()
				v_u_1368 = tick()
				v_u_1347.Parent = nil
				ResetButtonColor(v_u_1331)
				v_u_1370:disconnect()
				drag = nil
			end)
			v_u_1347.Parent = GetScreen(v_u_1329)
			v_u_1348:ScrollDown()
			wait(0.2)
			while v_u_1368 == v1369 do
				v_u_1348:ScrollDown()
				if not v_u_1348:CanScrollDown() then
					break
				end
				wait()
			end
		end)
		v_u_1331.MouseButton1Up:connect(function()
			v_u_1368 = tick()
		end)
		v_u_1336.MouseButton1Down:connect(function()
			v_u_1368 = tick()
			local v1371 = v_u_1368
			local v_u_1372 = nil
			v_u_1372 = v_u_1347.MouseButton1Up:connect(function()
				v_u_1368 = tick()
				v_u_1347.Parent = nil
				ResetButtonColor(v_u_1336)
				v_u_1372:disconnect()
				drag = nil
			end)
			v_u_1347.Parent = GetScreen(v_u_1329)
			v_u_1348:ScrollUp()
			wait(0.2)
			while v_u_1368 == v1371 do
				v_u_1348:ScrollUp()
				if not v_u_1348:CanScrollUp() then
					break
				end
				wait()
			end
		end)
		v_u_1336.MouseButton1Up:connect(function()
			v_u_1368 = tick()
		end)
		if p1328 then
			v_u_1341.MouseButton1Down:connect(function(p1373, _)
				v_u_1368 = tick()
				local v1374 = v_u_1368
				local v_u_1375 = nil
				v_u_1375 = v_u_1347.MouseButton1Up:connect(function()
					v_u_1368 = tick()
					v_u_1347.Parent = nil
					ResetButtonColor(v_u_1336)
					v_u_1375:disconnect()
				...
				v_u_1347.Parent = GetScreen(v_u_1329)
				if v_u_1342.AbsolutePosition.x < p1373 then
					v_u_1348:ScrollTo(v_u_1348.ScrollIndex + v_u_1348.VisibleSpace)
					wait(0.2)
					while v_u_1368 == v1374 and p1373 >= v_u_1342.AbsolutePosition.x + v_u_1342.AbsoluteSize.x do
						v_u_1348:ScrollTo(v_u_1348.ScrollIndex + v_u_1348.VisibleSpace)
						wait()
					end
				else
					v_u_1348:ScrollTo(v_u_1348.ScrollIndex - v_u_1348.VisibleSpace)
					wait(0.2)
					while v_u_1368 == v1374 and v_u_1342.AbsolutePosition.x >= p1373 do
						v_u_1348:ScrollTo(v_u_1348.ScrollIndex - v_u_1348.VisibleSpace)
						wait()
					end
				end
			...
			v_u_1341.MouseButton1Down:connect(function(_, p1376)
				v_u_1368 = tick()
				local v1377 = v_u_1368
				local v_u_1378 = nil
				v_u_1378 = v_u_1347.MouseButton1Up:connect(function()
					v_u_1368 = tick()
					v_u_1347.Parent = nil
					ResetButtonColor(v_u_1336)
					v_u_1378:disconnect()
				...
				v_u_1347.Parent = GetScreen(v_u_1329)
				if v_u_1342.AbsolutePosition.y < p1376 then
					v_u_1348:ScrollTo(v_u_1348.ScrollIndex + v_u_1348.VisibleSpace)
					wait(0.2)
					while v_u_1368 == v1377 and p1376 >= v_u_1342.AbsolutePosition.y + v_u_1342.AbsoluteSize.y do
						v_u_1348:ScrollTo(v_u_1348.ScrollIndex + v_u_1348.VisibleSpace)
						wait()
					end
				else
					v_u_1348:ScrollTo(v_u_1348.ScrollIndex - v_u_1348.VisibleSpace)
					wait(0.2)
					while v_u_1368 == v1377 and v_u_1342.AbsolutePosition.y >= p1376 do
						v_u_1348:ScrollTo(v_u_1348.ScrollIndex - v_u_1348.VisibleSpace)
						wait()
					end
				end
		...
		if p1328 then
			v_u_1342.MouseButton1Down:connect(function(p1379, _)
				v_u_1368 = tick()
				local v_u_1380 = p1379 - v_u_1342.AbsolutePosition.x
				local v_u_1381 = nil
				local v_u_1387 = v_u_1347.MouseMoved:connect(function(p1382, _)
					local v1383 = v_u_1341.AbsolutePosition.x
					local v1384 = v_u_1341.AbsoluteSize.x - v_u_1342.AbsoluteSize.x
					local v1385 = v1383 + v1384
					local v1386 = p1382 - v_u_1380
					if v1386 < v1383 and v1383 then
						v1386 = v1383
					elseif v1385 < v1386 then
						if v1385 then
							v1386 = v1385
						end
					end
					v_u_1348:SetScrollPercent((v1386 - v1383) / v1384)
				end)
				v_u_1381 = v_u_1347.MouseButton1Up:connect(function()
					v_u_1368 = tick()
					v_u_1347.Parent = nil
					ResetButtonColor(v_u_1342)
					v_u_1387:disconnect()
					v_u_1387 = nil
					v_u_1381:disconnect()
					drag = nil
			...
			v_u_1342.MouseButton1Down:connect(function(_, p1388)
				v_u_1368 = tick()
				local v_u_1389 = p1388 - v_u_1342.AbsolutePosition.y
				local v_u_1390 = nil
				local v_u_1396 = v_u_1347.MouseMoved:connect(function(_, p1391)
					local v1392 = v_u_1341.AbsolutePosition.y
					local v1393 = v_u_1341.AbsoluteSize.y - v_u_1342.AbsoluteSize.y
					local v1394 = v1392 + v1393
					local v1395 = p1391 - v_u_1389
					if v1395 < v1392 and v1392 then
						v1395 = v1392
					elseif v1394 < v1395 then
						if v1394 then
							v1395 = v1394
						end
					end
					v_u_1348:SetScrollPercent((v1395 - v1392) / v1393)
				end)
				v_u_1390 = v_u_1347.MouseButton1Up:connect(function()
					v_u_1368 = tick()
					v_u_1347.Parent = nil
					ResetButtonColor(v_u_1342)
					v_u_1396:disconnect()
		...
		function v_u_1348.Destroy(_)
			v_u_1329:Destroy()
			v_u_1347:Destroy()
			for v1397 in pairs(v_u_1348) do
				v_u_1348[v1397] = nil
			end
			setmetatable(v_u_1348, nil)
		end
		v1367()
		return v_u_1348
	end
	local v_u_1398 = Instance.new("Frame")
	v_u_1398.Name = "MainFrame"
	v_u_1398.Size = UDim2.new(1, -16, 1, 0)
	v_u_1398.Position = UDim2.new(0, 0, 0, 0)
	v_u_1398.BackgroundTransparency = 1
	v_u_1398.ClipsDescendants = true
	v_u_1398.Parent = v_u_981
	ContentFrame = Instance.new("Frame")
	ContentFrame.Name = "ContentFrame"
	ContentFrame.Size = UDim2.new(1, 0, 0, 0)
	ContentFrame.BackgroundTransparency = 1
	ContentFrame.Parent = v_u_1398
	scrollBar = ScrollBar(false)
	scrollBar.PageIncrement = 1
	Create(
		scrollBar.GUI,
		{ ["Position"] = UDim2.new(1, -16, 0, 0), ["Size"] = UDim2.new(0, 16, 1, 0), ["Parent"] = v_u_981 }
	)
	...
	function scrollBar.UpdateCallback(_)
		...
		scrollBar.VisibleSpace = v_u_1398.AbsoluteSize.Y
	...
	v_u_1398.Changed:connect(function(p1399)
		if p1399 == "AbsoluteSize" then
			local v1400 = scrollBarH
			local v1401 = v_u_1398.AbsoluteSize.x
			v1400.VisibleSpace = math.ceil(v1401)
			scrollBarH:Update()
			local v1402 = scrollBar
			local v1403 = v_u_1398.AbsoluteSize.y
			v1402.VisibleSpace = math.ceil(v1403)
			scrollBar:Update()
		end
	end)
	local v_u_1404 = v_u_977.Height
	v_u_981.MouseWheelForward:connect(function()
		if v_u_1404 < scrollBar.VisibleSpace - 1 then
			scrollBar:ScrollTo(scrollBar.ScrollIndex - v_u_1404)
		else
			scrollBar:ScrollTo(scrollBar.ScrollIndex - scrollBar.VisibleSpace)
		end
	end)
	v_u_981.MouseWheelBackward:connect(function()
		if v_u_1404 < scrollBar.VisibleSpace - 1 then
			scrollBar:ScrollTo(scrollBar.ScrollIndex + v_u_1404)
		else
			scrollBar:ScrollTo(scrollBar.ScrollIndex + scrollBar.VisibleSpace)
	...
	local v1405 = scrollBar
	local v1406 = v_u_1398.AbsoluteSize.y
	v1405.VisibleSpace = math.ceil(v1406)
	scrollBar:Update()
	showProperties(v_u_995())
	v984.Event:connect(function()
		showProperties(v_u_995())
	end)
	v987.Event:connect(function(p_u_1407)
		if v_u_991 then
			v_u_991 = false
			if p_u_1407 then
				pcall(function()
					Set(v_u_992, v_u_993, p_u_1407)
				end)
			end
		end
	end)
	v_u_990.Changed:connect(function(p1408)
		if p1408 == "Text" then
			showProperties(v_u_995())
		end
	end)
	function v985.OnInvoke()
		return v_u_971
	end
	function v986.OnInvoke()
		return v_u_991
	end
end)
spawn(function()
	local v_u_1409 = v_u_164.ScriptEditor
	local v_u_1410 = v_u_1409:WaitForChild("EditorGrid")
	local v_u_1411 = ""
	game:GetService("UserInputService")
	local v1412 = game.Players.LocalPlayer:GetMouse()
	local v1413 = v_u_1409:WaitForChild("TopBar")
	local v_u_1414 = v1413:WaitForChild("ScriptBar")
	local v_u_1415 = v1413:WaitForChild("ScriptBarLeft")
	local v_u_1416 = v1413:WaitForChild("ScriptBarRight")
	local v1417 = v1413:WaitForChild("Clipboard")
	local v_u_1418 = v1413:WaitForChild("Entry")
	local v1419 = v_u_1409:WaitForChild("OpenScript")
	local v1420 = v_u_1409:WaitForChild("Close")
	local v_u_1421 = {}
	local v_u_1422 = 0
	local v_u_1423 = {
		["Background"] = Color3.new(0.9137254901960784, 0.9137254901960784, 0.9137254901960784),
	...
	local v_u_1424 = {}
	function SetZIndex(p1425, p1426)
		if not v_u_1424[p1425] then
			v_u_1424[p1425] = true
			if p1425:IsA("GuiObject") then
				p1425.ZIndex = p1426
			end
			local v1427 = p1425:GetChildren()
			for v1428 = 1, #v1427 do
				SetZIndex(v1427[v1428], p1426)
			end
			v_u_1424[p1425] = nil
		end
	end
	function SetZIndexOnChanged(p_u_1429)
		return p_u_1429.Changed:connect(function(p1430)
			if p1430 == "ZIndex" then
				SetZIndex(p_u_1429, p_u_1429.ZIndex)
			end
		end)
	end
	function Create(p1431, p1432)
		if type(p1431) == "string" then
			p1431 = Instance.new(p1431)
		end
		for v1433, v1434 in pairs(p1432) do
			if type(v1433) == "number" then
				v1434.Parent = p1431
			else
				p1431[v1433] = v1434
			end
	...
	function GetScreen(p1435)
		if p1435 == nil then
			return nil
		end
		while not p1435:IsA("ScreenGui") do
			p1435 = p1435.Parent
			if p1435 == nil then
				return nil
			end
	...
	function ResetButtonColor(p1436)
		local v1437 = p1436.Active
		p1436.Active = not v1437
		p1436.Active = v1437
	end
	function ArrowGraphic(p_u_1438, p1439, p1440, p1441)
		local v1442 = Create(
			"Frame",
			{
				["Name"] = "Arrow Graphic",
				["BorderSizePixel"] = 0,
				["Size"] = UDim2.new(0, p_u_1438, 0, p_u_1438),
				["Transparency"] = 1,
			}
		)
		if not p1441 then
			p1441 = Instance.new("Frame")
			p1441.BorderSizePixel = 0
		end
		local v1443 = nil
		if p1439 == nil or p1439 == "Up" then
			v1443 = function(p1444, p1445)
				return p1444, p1445
			end
		elseif p1439 == "Down" then
			v1443 = function(p1446, p1447)
				return UDim2.new(0, p1446.X.Offset, 0, p_u_1438 - p1446.Y.Offset - 1), p1447
			end
		elseif p1439 == "Left" then
			v1443 = function(p1448, p1449)
				return UDim2.new(0, p1448.Y.Offset, 0, p1448.X.Offset), UDim2.new(0, p1449.Y.Offset, 0, p1449.X.Offset)
			end
		elseif p1439 == "Right" then
			v1443 = function(p1450, p1451)
				return UDim2.new(0, p_u_1438 - p1450.Y.Offset - 1, 0, p1450.X.Offset),
					UDim2.new(0, p1451.Y.Offset, 0, p1451.X.Offset)
			end
		end
		local v1452
		if p1440 then
			v1452 = function(p1453, p1454)
				return UDim2.new(p1453.X.Offset / p_u_1438, 0, p1453.Y.Offset / p_u_1438, 0),
					UDim2.new(p1454.X.Offset / p_u_1438, 0, p1454.Y.Offset / p_u_1438, 0)
			end
		else
			v1452 = function(p1455, p1456)
				return p1455, p1456
			end
		end
		local v1457 = p_u_1438 / 4
		local v1458 = math.floor(v1457)
		if p_u_1438 % 2 == 0 then
			local v1459 = p_u_1438 / 2 - 1
			for v1460 = 0, v1459 do
				local v1461 = p1441:Clone()
				local v1462, v1463 =
					v1452(v1443(UDim2.new(0, v1459 - v1460, 0, v1458 + v1460), UDim2.new(0, (v1460 + 1) * 2, 0, 1)))
				v1461.Position = v1462
				v1461.Size = v1463
				v1461.Parent = v1442
			end
		else
			local v1464 = (p_u_1438 - 1) / 2
			for v1465 = 0, v1464 do
				local v1466 = p1441:Clone()
				local v1467, v1468 =
					v1452(v1443(UDim2.new(0, v1464 - v1465, 0, v1458 + v1465), UDim2.new(0, v1465 * 2 + 1, 0, 1)))
				v1466.Position = v1467
				v1466.Size = v1468
				v1466.Parent = v1442
			end
		end
		if 1 < p_u_1438 % 4 then
			local v1469 = p1441:Clone()
			local v1470, v1471 = v1452(v1443(UDim2.new(0, 0, 0, p_u_1438 - v1458 - 1), UDim2.new(0, p_u_1438, 0, 1)))
			v1469.Position = v1470
			v1469.Size = v1471
			v1469.Parent = v1442
		end
		return v1442
	end
	function GripGraphic(p_u_1472, p1473, p1474, p1475, p1476)
		local v1477 = Create(
			"Frame",
			{
				["Name"] = "Grip Graphic",
				["BorderSizePixel"] = 0,
				["Size"] = UDim2.new(0, p_u_1472.x, 0, p_u_1472.y),
				["Transparency"] = 1,
			}
		)
		if not p1476 then
			p1476 = Instance.new("Frame")
			p1476.BorderSizePixel = 0
		end
		local v1478 = p1474 or 2
		local v1479
		if p1475 then
			v1479 = function(p1480)
				return UDim2.new(p1480.X.Offset / p_u_1472.x, 0, p1480.Y.Offset / p_u_1472.y, 0)
			end
		else
			v1479 = function(p1481)
				return p1481
			end
		end
		if p1473 == "Vertical" then
			for v1482 = 0, p_u_1472.x - 1, v1478 do
				local v1483 = p1476:Clone()
				v1483.Size = v1479(UDim2.new(0, 1, 0, p_u_1472.y))
				v1483.Position = v1479(UDim2.new(0, v1482, 0, 0))
				v1483.Parent = v1477
			end
			return v1477
		else
			if p1473 == nil or p1473 == "Horizontal" then
				for v1484 = 0, p_u_1472.y - 1, v1478 do
					local v1485 = p1476:Clone()
					v1485.Size = v1479(UDim2.new(0, p_u_1472.x, 0, 1))
					v1485.Position = v1479(UDim2.new(0, 0, 0, v1484))
					v1485.Parent = v1477
				end
			end
			return v1477
	...
	local v_u_1496 = {
		["__index"] = {
			["GetScrollPercent"] = function(p1486)
				return p1486.ScrollIndex / (p1486.TotalSpace - p1486.VisibleSpace)
			end,
			["CanScrollDown"] = function(p1487)
				return p1487.ScrollIndex + p1487.VisibleSpace < p1487.TotalSpace
			end,
			["CanScrollUp"] = function(p1488)
				return 0 < p1488.ScrollIndex
			end,
			["ScrollDown"] = function(p1489)
				p1489.ScrollIndex = p1489.ScrollIndex + p1489.PageIncrement
				p1489:Update()
			end,
			["ScrollUp"] = function(p1490)
				p1490.ScrollIndex = p1490.ScrollIndex - p1490.PageIncrement
				p1490:Update()
			end,
			["ScrollTo"] = function(p1491, p1492)
				p1491.ScrollIndex = p1492
				p1491:Update()
			end,
			["SetScrollPercent"] = function(p1493, p1494)
				local v1495 = (p1493.TotalSpace - p1493.VisibleSpace) * p1494 + 0.5
				p1493.ScrollIndex = math.floor(v1495)
				p1493:Update()
			end,
		},
	}
	v_u_1496.__index.CanScrollRight = v_u_1496.__index.CanScrollDown
	v_u_1496.__index.CanScrollLeft = v_u_1496.__index.CanScrollUp
	v_u_1496.__index.ScrollLeft = v_u_1496.__index.ScrollUp
	v_u_1496.__index.ScrollRight = v_u_1496.__index.ScrollDown
	function ScrollBar(p1497)
		local v_u_1498 = Create(
			"Frame",
			{
				["Name"] = "ScrollFrame",
				["Position"] = p1497 and UDim2.new(0, 0, 1, -16) or UDim2.new(1, -16, 0, 0),
				["Size"] = p1497 and UDim2.new(1, 0, 0, 16) or UDim2.new(0, 16, 1, 0),
				["BackgroundTransparency"] = 1,
				Create(
					"ImageButton",
					{
						["Name"] = "ScrollDown",
						["Position"] = p1497 and UDim2.new(1, -16, 0, 0) or UDim2.new(0, 0, 1, -16),
						["Size"] = UDim2.new(0, 16, 0, 16),
						["BackgroundColor3"] = v_u_1423.Button,
						["BorderColor3"] = v_u_1423.Border,
					}
				),
				Create(
					"ImageButton",
				...
				Create(
					...
					{
						["Name"] = "ScrollBar",
						["Size"] = p1497 and UDim2.new(1, -32, 1, 0) or UDim2.new(1, 0, 1, -32),
						["Position"] = p1497 and UDim2.new(0, 16, 0, 0) or UDim2.new(0, 0, 0, 16),
						["AutoButtonColor"] = false,
						["BackgroundColor3"] = Color3.new(0.94902, 0.94902, 0.94902),
						["BorderColor3"] = v_u_1423.Border,
						Create(
		...
		local v1499 =
			Create("Frame", { ["Name"] = "Graphic", ["BorderSizePixel"] = 0, ["BackgroundColor3"] = v_u_1423.Border })
		local v_u_1500 = v_u_1498.ScrollDown
		local v1501 = ArrowGraphic
		local v1502 = 8
		local v1503
		if p1497 then
			v1503 = "Right"
		...
		local v_u_1504 = v1501(v1502, v1503, true, v1499)
		v_u_1504.Position = UDim2.new(0.5, -4, 0.5, -4)
		v_u_1504.Parent = v_u_1500
		local v_u_1505 = v_u_1498.ScrollUp
		local v1506 = ArrowGraphic
		local v1507 = 8
		local v1508
		if p1497 then
			v1508 = "Left"
		...
		local v_u_1509 = v1506(v1507, v1508, true, v1499)
		v_u_1509.Position = UDim2.new(0.5, -4, 0.5, -4)
		v_u_1509.Parent = v_u_1505
		local v_u_1510 = v_u_1498.ScrollBar
		local v_u_1511 = v_u_1510.ScrollThumb
		local v1512 = GripGraphic
		local v1513 = Vector2.new(6, 6)
		local v1514
		if p1497 then
			v1514 = "Vertical"
		else
		...
		local v1515 = v1512(v1513, v1514, 2, v1499)
		v1515.Position = UDim2.new(0.5, -3, 0.5, -3)
		v1515.Parent = v_u_1511
		local v_u_1516 = Create(
			"ImageButton",
			{
				["Name"] = "MouseDrag",
				["Position"] = UDim2.new(-0.25, 0, -0.25, 0),
		...
		local v_u_1517 = setmetatable(
			{ ["GUI"] = v_u_1498, ["ScrollIndex"] = 0, ["VisibleSpace"] = 0, ["TotalSpace"] = 0, ["PageIncrement"] = 1 },
			v_u_1496
		)
		local v_u_1518
		if p1497 then
			v_u_1518 = function()
				v_u_1511.Size = UDim2.new(v_u_1517.VisibleSpace / v_u_1517.TotalSpace, 0, 0, 16)
				if v_u_1511.AbsoluteSize.x < 16 then
					v_u_1511.Size = UDim2.new(0, 16, 0, 16)
				end
				local v1519 = v_u_1510.AbsoluteSize.x
				v_u_1511.Position =
					UDim2.new(v_u_1517:GetScrollPercent() * (v1519 - v_u_1511.AbsoluteSize.x) / v1519, 0, 0, 0)
			end
		else
			v_u_1518 = function()
				v_u_1511.Size = UDim2.new(0, 16, v_u_1517.VisibleSpace / v_u_1517.TotalSpace, 0)
				if v_u_1511.AbsoluteSize.y < 16 then
					v_u_1511.Size = UDim2.new(0, 16, 0, 16)
				end
				local v1520 = v_u_1510.AbsoluteSize.y
				v_u_1511.Position =
					UDim2.new(0, 0, v_u_1517:GetScrollPercent() * (v1520 - v_u_1511.AbsoluteSize.y) / v1520, 0)
			end
		end
		local v_u_1521 = nil
		local v_u_1522 = nil
		local v_u_1523 = { ["BackgroundColor3"] = v_u_1423.Border, ["BackgroundTransparency"] = 0 }
		local v_u_1524 = { ["BackgroundColor3"] = v_u_1423.Border, ["BackgroundTransparency"] = 0.7 }
		local function v1536()
			local v1525 = v_u_1517.TotalSpace
			local v1526 = v_u_1517.VisibleSpace
			local v1527 = v_u_1517.ScrollIndex
			if v1526 <= v1525 then
				if 0 < v1527 then
					if v1525 < v1527 + v1526 then
						v_u_1517.ScrollIndex = v1525 - v1526
					end
				else
			...
			if v_u_1517.UpdateCallback and v_u_1517.UpdateCallback(v_u_1517) == false then
				...
				if v1528 ~= v_u_1521 then
					v_u_1521 = v1528
					v_u_1500.Active = v1528
					v_u_1500.AutoButtonColor = v1528
					local v1530 = v_u_1504:GetChildren()
					local v1531 = v1528 and v_u_1523
					if not v1531 then
						v1531 = v_u_1524
					end
					for v1532 = 1, #v1530 do
						Create(v1530[v1532], v1531)
					end
				end
				if v1529 ~= v_u_1522 then
					v_u_1522 = v1529
					v_u_1505.Active = v1529
					v_u_1505.AutoButtonColor = v1529
					local v1533 = v_u_1509:GetChildren()
					local v1534 = v1529 and v_u_1523
					if not v1534 then
						v1534 = v_u_1524
					end
					for v1535 = 1, #v1533 do
						Create(v1533[v1535], v1534)
					end
				end
				v_u_1511.Visible = v1528 or v1529
				v_u_1518()
			end
		end
		v_u_1517.Update = v1536
		SetZIndexOnChanged(v_u_1498)
		local v_u_1537 = 0
		v_u_1500.MouseButton1Down:connect(function()
			v_u_1537 = tick()
			local v1538 = v_u_1537
			local v_u_1539 = nil
			v_u_1539 = v_u_1516.MouseButton1Up:connect(function()
				v_u_1537 = tick()
				v_u_1516.Parent = nil
				ResetButtonColor(v_u_1500)
				v_u_1539:disconnect()
				drag = nil
			end)
			v_u_1516.Parent = GetScreen(v_u_1498)
			v_u_1517:ScrollDown()
			wait(0.2)
			while v_u_1537 == v1538 do
				v_u_1517:ScrollDown()
				if not v_u_1517:CanScrollDown() then
					break
				end
				wait()
			end
		end)
		v_u_1500.MouseButton1Up:connect(function()
			v_u_1537 = tick()
		end)
		v_u_1505.MouseButton1Down:connect(function()
			v_u_1537 = tick()
			local v1540 = v_u_1537
			local v_u_1541 = nil
			v_u_1541 = v_u_1516.MouseButton1Up:connect(function()
				v_u_1537 = tick()
				v_u_1516.Parent = nil
				ResetButtonColor(v_u_1505)
				v_u_1541:disconnect()
				drag = nil
			end)
			v_u_1516.Parent = GetScreen(v_u_1498)
			v_u_1517:ScrollUp()
			wait(0.2)
			while v_u_1537 == v1540 do
				v_u_1517:ScrollUp()
				if not v_u_1517:CanScrollUp() then
					break
				end
				wait()
			end
		end)
		v_u_1505.MouseButton1Up:connect(function()
			v_u_1537 = tick()
		end)
		if p1497 then
			v_u_1510.MouseButton1Down:connect(function(p1542, _)
				v_u_1537 = tick()
				local v1543 = v_u_1537
				local v_u_1544 = nil
				v_u_1544 = v_u_1516.MouseButton1Up:connect(function()
					v_u_1537 = tick()
					v_u_1516.Parent = nil
					ResetButtonColor(v_u_1505)
					v_u_1544:disconnect()
				...
				v_u_1516.Parent = GetScreen(v_u_1498)
				if v_u_1511.AbsolutePosition.x < p1542 then
					v_u_1517:ScrollTo(v_u_1517.ScrollIndex + v_u_1517.VisibleSpace)
					wait(0.2)
					while v_u_1537 == v1543 and p1542 >= v_u_1511.AbsolutePosition.x + v_u_1511.AbsoluteSize.x do
						v_u_1517:ScrollTo(v_u_1517.ScrollIndex + v_u_1517.VisibleSpace)
						wait()
					end
				else
					v_u_1517:ScrollTo(v_u_1517.ScrollIndex - v_u_1517.VisibleSpace)
					wait(0.2)
					while v_u_1537 == v1543 and v_u_1511.AbsolutePosition.x >= p1542 do
						v_u_1517:ScrollTo(v_u_1517.ScrollIndex - v_u_1517.VisibleSpace)
						wait()
					end
				end
			...
			v_u_1510.MouseButton1Down:connect(function(_, p1545)
				v_u_1537 = tick()
				local v1546 = v_u_1537
				local v_u_1547 = nil
				v_u_1547 = v_u_1516.MouseButton1Up:connect(function()
					v_u_1537 = tick()
					v_u_1516.Parent = nil
					ResetButtonColor(v_u_1505)
					v_u_1547:disconnect()
				...
				v_u_1516.Parent = GetScreen(v_u_1498)
				if v_u_1511.AbsolutePosition.y < p1545 then
					v_u_1517:ScrollTo(v_u_1517.ScrollIndex + v_u_1517.VisibleSpace)
					wait(0.2)
					while v_u_1537 == v1546 and p1545 >= v_u_1511.AbsolutePosition.y + v_u_1511.AbsoluteSize.y do
						v_u_1517:ScrollTo(v_u_1517.ScrollIndex + v_u_1517.VisibleSpace)
						wait()
					end
				else
					v_u_1517:ScrollTo(v_u_1517.ScrollIndex - v_u_1517.VisibleSpace)
					wait(0.2)
					while v_u_1537 == v1546 and v_u_1511.AbsolutePosition.y >= p1545 do
						v_u_1517:ScrollTo(v_u_1517.ScrollIndex - v_u_1517.VisibleSpace)
						wait()
					end
				end
		...
		if p1497 then
			v_u_1511.MouseButton1Down:connect(function(p1548, _)
				v_u_1537 = tick()
				local v_u_1549 = p1548 - v_u_1511.AbsolutePosition.x
				local v_u_1550 = nil
				local v_u_1556 = v_u_1516.MouseMoved:connect(function(p1551, _)
					local v1552 = v_u_1510.AbsolutePosition.x
					local v1553 = v_u_1510.AbsoluteSize.x - v_u_1511.AbsoluteSize.x
					local v1554 = v1552 + v1553
					local v1555 = p1551 - v_u_1549
					if v1555 < v1552 and v1552 then
						v1555 = v1552
					elseif v1554 < v1555 then
						if v1554 then
							v1555 = v1554
						end
					end
					v_u_1517:SetScrollPercent((v1555 - v1552) / v1553)
				end)
				v_u_1550 = v_u_1516.MouseButton1Up:connect(function()
					v_u_1537 = tick()
					v_u_1516.Parent = nil
					ResetButtonColor(v_u_1511)
					v_u_1556:disconnect()
					v_u_1556 = nil
					v_u_1550:disconnect()
					drag = nil
			...
			v_u_1511.MouseButton1Down:connect(function(_, p1557)
				v_u_1537 = tick()
				local v_u_1558 = p1557 - v_u_1511.AbsolutePosition.y
				local v_u_1559 = nil
				local v_u_1565 = v_u_1516.MouseMoved:connect(function(_, p1560)
					local v1561 = v_u_1510.AbsolutePosition.y
					local v1562 = v_u_1510.AbsoluteSize.y - v_u_1511.AbsoluteSize.y
					local v1563 = v1561 + v1562
					local v1564 = p1560 - v_u_1558
					if v1564 < v1561 and v1561 then
						v1564 = v1561
					elseif v1563 < v1564 then
						if v1563 then
							v1564 = v1563
						end
					end
					v_u_1517:SetScrollPercent((v1564 - v1561) / v1562)
				end)
				v_u_1559 = v_u_1516.MouseButton1Up:connect(function()
					v_u_1537 = tick()
					v_u_1516.Parent = nil
					ResetButtonColor(v_u_1511)
					v_u_1565:disconnect()
		...
		function v_u_1517.Destroy(_)
			v_u_1498:Destroy()
			v_u_1516:Destroy()
			for v1566 in pairs(v_u_1517) do
				v_u_1517[v1566] = nil
			end
			setmetatable(v_u_1517, nil)
		end
		v1536()
		return v_u_1517
	end
	local v_u_1567 = ScrollBar(false)
	v_u_1567.PageIncrement = 16
	Create(
		v_u_1567.GUI,
		{ ["Position"] = UDim2.new(1, 0, 0, 0), ["Size"] = UDim2.new(0, 16, 1, 0), ["Parent"] = v_u_1410 }
	)
	local v_u_1568 = ScrollBar(true)
	v_u_1568.PageIncrement = 8
	Create(
		v_u_1568.GUI,
		{ ["Position"] = UDim2.new(0, 0, 1, 0), ["Size"] = UDim2.new(1, 0, 0, 16), ["Parent"] = v_u_1410 }
	)
	local v_u_1569 = {}
	local v_u_1570 = {}
	local v1571 = 1
	local v1572 = 1
	local v_u_1573 = 0
	for v1574 = 0, 490, 8 do
		local v1575 = {}
		for v1576 = 0, 390, 16 do
			local v1577 = Instance.new("TextLabel", v_u_1410)
			v1577.BackgroundTransparency = 1
			v1577.BorderSizePixel = 0
			v1577.Text = ""
			v1577.Position = UDim2.new(0, v1574, 0, v1576)
			v1577.Size = UDim2.new(0, 8, 0, 16)
			v1577.Font = Enum.Font.SourceSans
			v1577.FontSize = Enum.FontSize.Size18
			table.insert(v1575, v1577)
			v1572 = v1572 + 1
		end
		table.insert(v_u_1570, v1575)
		v1571 = v1571 + 1
		v1572 = 1
	end
	local v_u_1578 = {
	...
	function checkMouseInGui(p1579)
		if p1579 == nil then
			return false
		end
		local v1580 = game.Players.LocalPlayer:GetMouse()
		local v1581 = p1579.AbsolutePosition
		local v1582 = p1579.AbsoluteSize
		return v1580.X >= v1581.x
			and v1580.X <= v1581.x + v1582.x
			and v1580.Y >= v1581.y
			and v1580.Y <= v1581.y + v1582.y
	end
	function AddZeros(p1583, p1584)
		local v1585 = tostring(p1583)
		while #v1585 < p1584 do
			v1585 = " " .. v1585
		end
		return v1585
	end
	function buildScript(p1586, p1587, p1588, p1589)
		local v1590 = true
		if v_u_1411 ~= p1586 then
			v_u_1411 = p1586
		end
		if p1589 then
			v_u_1411 = p1586
			v_u_1569 = {}
			while v1590 do
				local v1591, v1592 = string.find(p1586, "\n")
				if v1591 and v1592 then
					local v1593 = string.sub
					table.insert(v_u_1569, v1593(p1586, 1, v1592))
					local v1594 = v1592 + 1
					local v1595 = string.len
					p1586 = string.sub(p1586, v1594, v1595(p1586))
				else
					table.insert(v_u_1569, p1586)
					v1590 = false
				end
			end
		end
		local v1596 = #v_u_1569
		v_u_1573 = #tostring(v1596)
		if v_u_1573 == 1 then
			v_u_1573 = 2
		end
		local v1597 = 1
		local v1598 = 2 + v_u_1573
		local v1599 = 0
		local v1600 = nil
		local v1601 = false
		local v1602 = v_u_1569
		for v1603 = 1, #v_u_1570 do
			for v1604 = 1, #v_u_1570[v1603] do
				if v1603 <= v_u_1573 then
					local v1605 = AddZeros(p1588 + v1604, v_u_1573)
					local v1606 = string.sub(v1605, v1603, v1603)
					if v1606 == " " then
						v_u_1570[v1603][v1604].Text = ""
					else
						v_u_1570[v1603][v1604].Text = v1606
					end
					v_u_1570[v1603][v1604].BackgroundTransparency = 0
					v_u_1570[v1603][v1604].BackgroundColor3 =
						Color3.new(0.6392156862745098, 0.6352941176470588, 0.6470588235294118)
				elseif v1603 == v_u_1573 + 1 then
					v_u_1570[v1603][v1604].Text = ""
					v_u_1570[v1603][v1604].BackgroundTransparency = 0
					v_u_1570[v1603][v1604].BackgroundColor3 =
					...
					v_u_1570[v1603][v1604].Text = ""
					v_u_1570[v1603][v1604].BackgroundTransparency = 1
				end
			end
		end
		local v1607 = p1587
		while true do
			if #v1602 < v1597 or #v_u_1570[1] < v1597 then
				return
			end
			local v1608 = v1602[v1597 + p1588]
			while 0 < string.len(v1608) do
				if string.sub(v1608, 1, 1) == "\t" then
					v1608 = "    " .. string.sub(v1608, 2)
				end
				if #v_u_1570 < v1598 then
					break
				end
				if v1607 == 0 then
					v_u_1570[v1598][v1597].Text = string.sub(v1608, 1, 1)
				end
				if not v1601 then
					for _, v1609 in pairs(v_u_1578) do
						local v1610 = v1609.Keyword
						local v1611 = string.len
						if string.sub(v1608, 1, v1611(v1610)) == v1609.Keyword then
							if v1609.Independent then
								local v1612 = v1609.Keyword
								local v1613 = string.len(v1612) + 1
								local v1614 = string.sub(v1608, v1613, v1613)
								if not string.find(v1614, "%w") then
									local v1615 = v1609.Keyword
									v1599 = string.len(v1615)
									v1600 = v1609.Color
								end
							else
								local v1616 = v1609.Keyword
								v1599 = string.len(v1616)
								v1600 = v1609.Color
							end
						end
					end
				...
				if string.sub(v1608, 1, 1) == '"' then
					if string.match(v1608, '".+"') then
						local v1617 = string.match
						v1599 = string.len(v1617(v1608, '".+"'))
						v1600 = Color3.new(0.6666666666666666, 0, 1)
						v1601 = true
					end
				end
				if 0 < v1599 then
					v1599 = v1599 - 1
					v_u_1570[v1598][v1597].TextColor3 = v1600
					if v1599 == 0 then
						v1601 = false
					end
				else
					v_u_1570[v1598][v1597].TextColor3 = Color3.new(0, 0, 0)
					v1601 = false
				end
				if v1607 == 0 then
					v1598 = v1598 + 1
				...
				local v1618 = string.len
				v1608 = string.sub(v1608, 2, v1618(v1608))
			end
			v1597 = v1597 + 1
			v1598 = 2 + v_u_1573
			v1599 = 0
	...
	function v_u_1567.UpdateCallback(_)
		v_u_1567.TotalSpace = #v_u_1569 * 16
		v_u_1567.VisibleSpace = v_u_1410.AbsoluteSize.Y
		local v1619 = buildScript
		local v1620 = v_u_1568.ScrollIndex / 8
		local v1621 = math.floor(v1620)
		local v1622 = v_u_1567.ScrollIndex / 16
		v1619(v_u_1411, v1621, math.floor(v1622))
	end
	function v_u_1568.UpdateCallback(_)
		v_u_1568.TotalSpace = (getLongestEntry(v_u_1569) + 1 + v_u_1573) * 8
		v_u_1568.VisibleSpace = v_u_1410.AbsoluteSize.X
		local v1623 = buildScript
		local v1624 = v_u_1568.ScrollIndex / 8
		local v1625 = math.floor(v1624)
		local v1626 = v_u_1567.ScrollIndex / 16
		v1623(v_u_1411, v1625, math.floor(v1626))
	end
	function getLongestEntry(p1627)
		local v1628 = 0
		for _, v1629 in pairs(p1627) do
			if v1628 < string.len(v1629) then
				v1628 = string.len(v1629)
			end
		end
		return v1628
	end
	function openScript(p1630)
		if p1630:IsA("LocalScript") then
			p1630.Archivable = true
			p1630 = p1630:Clone()
			p1630.Disabled = true
		end
		local v1631 = p1630.Name
		local v1632 = decompile(p1630)
		table.insert(v_u_1421, { ["Name"] = v1631, ["Source"] = v1632 })
		local v_u_1633 = v_u_1418:Clone()
		v_u_1633.Button.Text = v1631
		v_u_1633.Position = UDim2.new(0, #v_u_1414:GetChildren() * 100, 0, 0)
		v_u_1633.Visible = true
		v_u_1633.Button.MouseButton1Down:connect(function()
			for v1634, v1635 in pairs(v_u_1414:GetChildren()) do
				if v1635 == v_u_1633 then
					v_u_1422 = v1634
					buildScript(v_u_1421[v1634].Source, 0, 0, true)
					v_u_1567:ScrollTo(1)
					v_u_1567:Update()
					v_u_1568:ScrollTo(1)
					v_u_1568:Update()
		...
		v_u_1633.Close.MouseButton1Click:connect(function()
			for v1636, v1637 in pairs(v_u_1414:GetChildren()) do
				if v1637 == v_u_1633 then
					table.remove(v_u_1421, v1636)
					if v_u_1422 == v1636 then
						v_u_1422 = #v_u_1421
						if 0 < v_u_1422 then
							buildScript(v_u_1421[#v_u_1421].Source, 0, 0, true)
						else
					...
					v_u_1568:ScrollTo(1)
					v_u_1568:Update()
					for v1638 = v1636, #v_u_1414:GetChildren() do
						v_u_1414:GetChildren()[v1638].Position = v_u_1414:GetChildren()[v1638].Position
							+ UDim2.new(0, -100, 0, 0)
					end
					if v1636 < v_u_1422 then
						v_u_1422 = v_u_1422 - 1
					end
					v_u_1633:Destroy()
				end
		...
		v_u_1422 = #v_u_1421
		buildScript(v1632, 0, 0, true)
		v_u_1633.Parent = v_u_1414
	end
	function updateScriptBar()
		local v1639 = 0
		v_u_1415.Active = false
		v_u_1415.AutoButtonColor = false
		for _, v1640 in pairs(v_u_1415["Arrow Graphic"]:GetChildren()) do
			v1640.BackgroundTransparency = 0.7
		end
		v_u_1416.Active = false
		v_u_1416.AutoButtonColor = false
		for _, v1641 in pairs(v_u_1416["Arrow Graphic"]:GetChildren()) do
			v1641.BackgroundTransparency = 0.7
		end
		for _, v1642 in pairs(v_u_1414:GetChildren()) do
			if v1642.Position.X.Offset < 0 then
				v_u_1415.Active = true
				v_u_1415.AutoButtonColor = true
				for _, v1643 in pairs(v_u_1415["Arrow Graphic"]:GetChildren()) do
					v1643.BackgroundTransparency = 0
				end
			elseif 0 <= v1642.Position.X.Offset then
				v1639 = v1639 + 1
				if v1639 == 5 then
					v_u_1416.Active = true
					v_u_1416.AutoButtonColor = true
					for _, v1644 in pairs(v_u_1416["Arrow Graphic"]:GetChildren()) do
						v1644.BackgroundTransparency = 0
					end
				end
			end
		end
	...
	v1412.Button1Down:connect(function()
		checkMouseInGui(v_u_1410)
	end)
	v1419.Event:connect(function(...)
		v_u_1409.Visible = true
		local v1647 = { ... }
		if 0 < #v1647 then
			openScript(v1647[1])
		end
	end)
	v1417.MouseButton1Click:connect(function()
		if Clipboard and Clipboard.set then
			Clipboard.set(v_u_1411)
		elseif CopyString then
			CopyString(v_u_1411)
		end
	end)
	v1420.MouseButton1Click:connect(function()
		v_u_1409.Visible = false
	end)
	buildScript("", 0, 0, true)
	v_u_1567:Update()
	v_u_1568:Update()
